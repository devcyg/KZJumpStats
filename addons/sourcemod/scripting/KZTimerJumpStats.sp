...
// - Add Wrecker [ a new category of sounds has been added, "Wrecker"]
// - LongJump Styles [ The plugin automatically identifies whether your LongJump and PRE or NOPRE and creates a Separate Jumptop and chat color]
// - Hint Color [ You can change the color of your Hud / Speed ]
...
// - Add Reset Function Menu [ You can reset / ban players directly from JumpTop ] // Thx hiiamu
// - Add Ban Function Menu 
...
#define AUTHOR "1NutWunDeR, powerind"
#define VERSION "1.2"
#define ADMIN_LEVEL ADMFLAG_ROOT
#define DEBUG 0


///////////////////////////////////// Just copy any of the colors below [change the 0x01]
#define PREFIXCOLOR 0x01
//////////////////////////////////
#define WHITE 0x01
#define DARKRED 0x02
#define PURPLE 0x03
...
new Handle:g_hdist_wrecker_weird = INVALID_HANDLE;
new Float:g_dist_wrecker_weird;
//////////////////////////////////////////////////////
...
new Handle:g_hdist_wrecker_dropbhop = INVALID_HANDLE;
new Float:g_dist_wrecker_dropbhop;
//////////////////////////////////////////////////////
...
new Handle:g_hdist_wrecker_bhop = INVALID_HANDLE;
new Float:g_dist_wrecker_bhop;
//////////////////////////////////////////////////////
...
new Handle:g_hdist_wrecker_multibhop = INVALID_HANDLE;
new Float:g_dist_wrecker_multibhop;
//////////////////////////////////////////////////////
...
new Handle:g_hdist_wrecker_lj = INVALID_HANDLE;
new Float:g_dist_wrecker_lj;
//////////////////////////////////////////////////////
new Handle:g_hdist_good_ljcps = INVALID_HANDLE;
new Float:g_dist_good_ljcps;
new Handle:g_hdist_pro_ljcps = INVALID_HANDLE;
new Float:g_dist_pro_ljcps;
new Handle:g_hdist_leet_ljcps = INVALID_HANDLE;
new Float:g_dist_leet_ljcps;
new Handle:g_hdist_ownage_ljcps = INVALID_HANDLE;
new Float:g_dist_ownage_ljcps;
new Handle:g_hdist_wrecker_ljcps = INVALID_HANDLE;
new Float:g_dist_wrecker_ljcps;
//////////////////////////////////////////////////////
new Handle: g_ct_jumpstats;

//Cookies
new Handle: g_hSpeedPanelColorCookie = INVALID_HANDLE;
...
new g_js_WreckerJump_Count[MAXPLAYERS+1];
...
new Float:g_js_fPersonal_LjCps_Record[MAXPLAYERS+1]=-1.0;
new Float:g_js_fPersonal_LjBlockRecord_Dist[MAXPLAYERS+1]=-1.0;
new Float:g_js_fPersonal_LjCpsBlockRecord_Dist[MAXPLAYERS+1]=-1.0;
new g_iSpeedPanelColor[MAXPLAYERS+1];
...
new String:sql_insertPlayerJumpLjCps[] 			= "INSERT INTO playerjumpstats (steamid, name, ljcpsrecord, ljcpspre, ljcpsmax, ljcpsstrafes, ljcpssync, ljcpsheight) VALUES('%s', '%s', '%f', '%f', '%f', '%i', '%i', '%f');";
...
new String:sql_insertPlayerJumpLjCpsBlock[] 	= "INSERT INTO playerjumpstats (steamid, name, ljcpsblockdist, ljcpsblockrecord, ljcpsblockpre, ljcpsblockmax, ljcpsblockstrafes, ljcpsblocksync, ljcpsblockheight) VALUES('%s', '%s', '%i', '%f', '%f', '%f', '%i', '%i', '%f');";
...
new String:sql_updateLjCpsBlock[] 				= "UPDATE playerjumpstats SET name='%s', ljcpsblockdist ='%i', ljcpsblockrecord ='%f', ljcpsblockpre ='%f', ljcpsblockmax ='%f', ljcpsblockstrafes='%i', ljcpsblocksync='%i', ljcpsblockheight='%f' WHERE steamid = '%s';";
...
new String:sql_updateLjCps[] 					= "UPDATE playerjumpstats SET name='%s', ljcpsrecord ='%f', ljcpspre ='%f', ljcpsmax ='%f', ljcpsstrafes='%i', ljcpssync='%i', ljcpsheight='%f' WHERE steamid = '%s';";
...
new String:sql_selectPlayerJumpTopLJCpsBlock[] 	= "SELECT name, ljcpsblockdist, ljcpsblockrecord, ljcpsblockstrafes, steamid FROM playerjumpstats WHERE ljcpsblockdist > -1 ORDER BY ljcpsblockdist DESC, ljcpsblockrecord DESC LIMIT 20";
...
new String:sql_selectPlayerJumpTopLJCps[] 		= "SELECT name, ljcpsrecord, ljcpsstrafes, steamid FROM playerjumpstats WHERE ljcpsrecord > -1.0 ORDER BY ljcpsrecord DESC LIMIT 20";
...
new String:sql_selectPlayerJumpLJCpsBlock[] 	= "SELECT steamid, name, ljcpsblockdist, ljcpsblockrecord FROM playerjumpstats WHERE steamid = '%s';";
new String:sql_selectPlayerJumpLJ[] 			= "SELECT steamid, name, ljrecord FROM playerjumpstats WHERE steamid = '%s';";
new String:sql_selectPlayerJumpLJCps[] 			= "SELECT steamid, name, ljcpsrecord FROM playerjumpstats WHERE steamid = '%s';";
...
new String:sql_selectJumpStats[] 				= "SELECT steamid, name, bhoprecord, bhoppre, bhopmax, bhopstrafes, bhopsync, ljrecord, ljpre, ljmax, ljstrafes, ljsync, multibhoprecord, multibhoppre, multibhopmax, multibhopstrafes, multibhopcount, multibhopsync, wjrecord, wjpre, wjmax, wjstrafes, wjsync, dropbhoprecord, dropbhoppre, dropbhopmax, dropbhopstrafes, dropbhopsync, ljheight, bhopheight, multibhopheight, dropbhopheight, wjheight, ljblockdist, ljblockrecord, ljblockpre, ljblockmax, ljblockstrafes, ljblocksync, ljblockheight, ljcpsrecord, ljcpspre, ljcpsmax, ljcpsstrafes, ljcpssync, ljcpsheight, ljcpsblockdist, ljcpsblockrecord, ljcpsblockpre, ljcpsblockmax, ljcpsblockstrafes, ljcpsblocksync, ljcpsblockheight FROM playerjumpstats WHERE (wjrecord > -1.0 OR dropbhoprecord > -1.0 OR ljrecord > -1.0 OR ljcpsrecord > -1.0 OR bhoprecord > -1.0 OR multibhoprecord > -1.0) AND steamid = '%s';";
...
new String:sql_selectPlayerRankLjCps[] 			= "SELECT name FROM playerjumpstats WHERE ljcpsrecord >= (SELECT ljcpsrecord FROM playerjumpstats WHERE steamid = '%s' AND ljcpsrecord > -1.0) AND ljcpsrecord  > -1.0 ORDER BY ljcpsrecord;";
...
new String:sql_selectPlayerRankLjCpsBlock[] 	= "SELECT name FROM playerjumpstats WHERE ljcpsblockdist >= (SELECT ljcpsblockdist FROM playerjumpstats WHERE steamid = '%s' AND ljcpsblockdist > -1.0) AND ljcpsblockdist  > -1.0 ORDER BY ljcpsblockdist DESC, ljcpsblockrecord DESC;";
...
new String:sql_resetLjRecord[] 					= "UPDATE playerjumpstats SET ljrecord = '-1.0', ljcpsrecord = '-1.0' WHERE steamid = '%s';";
new String:sql_resetLjBlockRecord[] 			= "UPDATE playerjumpstats SET ljblockdist = '-1', ljcpsblockdist = '-1' WHERE steamid = '%s';";
new String:sql_resetMultiBhopRecord[] 			= "UPDATE playerjumpstats SET multibhoprecord = '-1.0' WHERE steamid = '%s';";
new String:sql_resetJumpStats[] 				= "UPDATE playerjumpstats SET multibhoprecord = '-1.0', ljrecord = '-1.0', ljcpsrecord = '-1.0', wjrecord = '-1.0', dropbhoprecord = '-1.0', bhoprecord = '-1.0', ljblockdist = '-1', ljcpsblockdist = '-1' WHERE steamid = '%s';";
...
public Plugin:myinfo =
{
	name = "KZ JumpStats",
	author = AUTHOR,
	description = "Modified version of KZJumpStats that has Wrecker and PreStrafe Styles",
	version = VERSION,
	url = "1.0"
};
...
public OnPluginStart()
{
	...
	g_hdist_good_lj    			= CreateConVar("js_dist_min_lj", "245.0", "Minimum distance for longjumps to be considered good [Client Message]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	g_hdist_pro_lj   			= CreateConVar("js_dist_pro_lj", "255.0", "Minimum distance for longjumps to be considered pro [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 220.0, true, 999.0);
	g_hdist_leet_lj    			= CreateConVar("js_dist_leet_lj", "260.0", "Minimum distance for longjumps to be considered leet [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 245.0, true, 999.0);
	g_hdist_ownage_lj    		= CreateConVar("js_dist_ownage_lj", "265.0", "Minimum distance for longjumps to be considered ownage [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 245.0, true, 999.0);
	g_hdist_wrecker_lj    		= CreateConVar("js_dist_wrecker_lj", "270.0", "Minimum distance for longjumps to be considered wrecker [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 245.0, true, 999.0);

	g_hdist_good_ljcps    		= CreateConVar("js_dist_min_ljcps", "265.0", "Minimum distance for longjumps[P] to be considered good [Client Message]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	g_hdist_pro_ljcps   		= CreateConVar("js_dist_pro_ljcps", "270.0", "Minimum distance for longjumps[P] to be considered pro [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 220.0, true, 999.0);
	g_hdist_leet_ljcps    		= CreateConVar("js_dist_leet_ljcps", "275.0", "Minimum distance for longjumps[P] to be considered leet [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 245.0, true, 999.0);
	g_hdist_ownage_ljcps    	= CreateConVar("js_dist_ownage_ljcps", "280.0", "Minimum distance for longjumps[P] to be considered ownage [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 245.0, true, 999.0);
	g_hdist_wrecker_ljcps    	= CreateConVar("js_dist_wrecker_ljcps", "283.0", "Minimum distance for longjumps[P] to be considered wrecker [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 245.0, true, 999.0);

	g_hdist_good_weird  		= CreateConVar("js_dist_min_wj", "270.0", "Minimum distance for weird jumps to be considered good [Client Message]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	g_hdist_pro_weird  			= CreateConVar("js_dist_pro_wj", "280.0", "Minimum distance for weird jumps to be considered pro [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	g_hdist_leet_weird   		= CreateConVar("js_dist_leet_wj", "285.0", "Minimum distance for weird jumps to be considered leet [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	...
	g_hdist_wrecker_weird   	= CreateConVar("js_dist_wrecker_wj", "292.0", "Minimum distance for weird jumps to be considered wrecker [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 999.0);

	g_hdist_good_dropbhop  		= CreateConVar("js_dist_min_dropbhop", "270.0", "Minimum distance for drop bhops to be considered good [Client Message]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	g_hdist_pro_dropbhop  		= CreateConVar("js_dist_pro_dropbhop", "280.0", "Minimum distance for drop bhops to be considered pro [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	g_hdist_leet_dropbhop   	= CreateConVar("js_dist_leet_dropbhop", "285.0", "Minimum distance for drop bhops to be considered leet [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	...
	g_hdist_wrecker_dropbhop   	= CreateConVar("js_dist_wrecker_dropbhop", "292.0", "Minimum distance for drop bhops to be considered wrecker [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 999.0);

	g_hdist_good_bhop  			= CreateConVar("js_dist_min_bhop", "270.0", "Minimum distance for bhops to be considered good [Client Message]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	g_hdist_pro_bhop  			= CreateConVar("js_dist_pro_bhop", "280.0", "Minimum distance for bhops to be considered pro [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	g_hdist_leet_bhop   		= CreateConVar("js_dist_leet_bhop", "285.0", "Minimum distance for bhops to be considered leet [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 999.0);
	...
	g_hdist_wrecker_bhop   		= CreateConVar("js_dist_wrecker_bhop", "292.0", "Minimum distance for bhops to be considered wrecker [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 999.0);

	g_hdist_good_multibhop  	= CreateConVar("js_dist_min_multibhop", "270.0", "Minimum distance for multi-bhops to be considered good [Client Message]", FCVAR_NOTIFY, true, 200.0, true, 9999.0);
	g_hdist_pro_multibhop  		= CreateConVar("js_dist_pro_multibhop", "280.0", "Minimum distance for multi-bhops to be considered pro [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 9999.0);
	g_hdist_leet_multibhop   	= CreateConVar("js_dist_leet_multibhop", "285.0", "Minimum distance for multi-bhops to be considered leet [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 9999.0);
	...
	g_hdist_wrecker_multibhop 	= CreateConVar("js_dist_wrecker_multibhop", "292.0", "Minimum distance for multi-bhops to be considered Wrecker [JumpStats Colorchat All]", FCVAR_NOTIFY, true, 200.0, true, 9999.0);
	...
	g_dist_wrecker_weird    = GetConVarFloat(g_hdist_wrecker_weird);
	HookConVarChange(g_hdist_wrecker_weird, OnSettingChanged);
	...
	g_dist_wrecker_dropbhop    = GetConVarFloat(g_hdist_wrecker_dropbhop);
	HookConVarChange(g_hdist_wrecker_dropbhop, OnSettingChanged);
	...
	g_dist_wrecker_bhop    = GetConVarFloat(g_hdist_wrecker_bhop);
	HookConVarChange(g_hdist_wrecker_bhop, OnSettingChanged);
	...
	g_dist_wrecker_multibhop    = GetConVarFloat(g_hdist_wrecker_multibhop);
	HookConVarChange(g_hdist_wrecker_multibhop, OnSettingChanged);
	...
	g_dist_wrecker_lj      = GetConVarFloat(g_hdist_wrecker_lj);
	HookConVarChange(g_hdist_wrecker_lj, OnSettingChanged);

	////////////////////////////////////////////////////////////////

	g_dist_good_ljcps      = GetConVarFloat(g_hdist_good_ljcps);
	HookConVarChange(g_hdist_good_ljcps, OnSettingChanged);

	g_dist_pro_ljcps      = GetConVarFloat(g_hdist_pro_ljcps);
	HookConVarChange(g_hdist_pro_ljcps, OnSettingChanged);

	g_dist_leet_ljcps      = GetConVarFloat(g_hdist_leet_ljcps);
	HookConVarChange(g_hdist_leet_ljcps, OnSettingChanged);

	g_dist_ownage_ljcps      = GetConVarFloat(g_hdist_ownage_ljcps);
	HookConVarChange(g_hdist_ownage_ljcps, OnSettingChanged);

	g_dist_wrecker_ljcps      = GetConVarFloat(g_hdist_wrecker_ljcps);
	HookConVarChange(g_hdist_wrecker_ljcps, OnSettingChanged);
	...
	RegConsoleCmd("sm_setljblock", 				Command_Setljblock, "registers a lj block");	
	...
	// JumpTop Configs
	RegConsoleCmd("sm_jumptop", 				Client_Top, 									"Open a JumpTop Menu");

	RegAdminCmd("sm_resetjumpstats",			Admin_DropPlayerJump, ADMIN_LEVEL, 				"JS | Resets jump stats - requires z flag");
	RegAdminCmd("sm_resetallljrecords", 		Admin_ResetAllLjRecords, ADMIN_LEVEL, 			"JS | Resets all lj records - requires z flag"); //VOLTAR AQUI DEPOIS
	...
	RegAdminCmd("sm_resetljcpsrecord", 			Admin_ResetLjRecords, ADMIN_LEVEL, 				"JS | Resets ljcps record for given steamid - requires z flag");
	RegAdminCmd("sm_resetljcpsblockrecord", 	Admin_ResetLjBlockRecords, ADMIN_LEVEL, 		"JS | Resets ljcps block record for given steamid - requires z flag");
	...
	g_hSpeedPanelColorCookie = RegClientCookie("SpeedColorCookie", "Speed Panel Speed Color Cookie", CookieAccess_Private);
}
...
public OnClientPostAdminCheck(int client)
	{
		...
		{
			GetClientCookie(client, g_hSpeedPanelColorCookie, sCookie, sizeof(sCookie));
			g_iSpeedPanelColor[client] = StringToInt(sCookie);
		}	
		else 
		{
			GetClientCookie(client, g_hSpeedPanelColorCookie, sCookie, sizeof(sCookie));
...
public OnClientPutInServer(client)
{
	...
	db_viewPersonalLJCPSBlockRecord(client, szSteamId);
	db_viewPersonalLJCPSRecord(client, szSteamId);
}
...
public Action:AdvertTimer(Handle:timer, any:client)
{
	if (IsValidClient(client) && !IsFakeClient(client))
		PrintToConsole(client, "This server is using KZTimer Jumpstats");
}
...
// ownage = GOLD
	...
	AddFileToDownloadsTable( OWNAGEJUMP_HOLYSHIT_FULL_SOUND_PATH );
	FakePrecacheSound( OWNAGEJUMP_HOLYSHIT_RELATIVE_SOUND_PATH );
	AddFileToDownloadsTable( OWNAGEJUMP_WICKEDSICK_FULL_SOUND_PATH );
	FakePrecacheSound( OWNAGEJUMP_WICKEDSICK_RELATIVE_SOUND_PATH );
// wrecker = PINK
	AddFileToDownloadsTable( WRECKERJUMP_FULL_SOUND_PATH );
	FakePrecacheSound( WRECKERJUMP_RELATIVE_SOUND_PATH ); 
	AddFileToDownloadsTable( WRECKERJUMP_UNSTOPPABLE_FULL_SOUND_PATH );
	FakePrecacheSound( WRECKERJUMP_UNSTOPPABLE_RELATIVE_SOUND_PATH ); 
	AddFileToDownloadsTable( WRECKERJUMP_COMBOWHORE_FULL_SOUND_PATH );
	FakePrecacheSound( WRECKERJUMP_COMBOWHORE_RELATIVE_SOUND_PATH ); 
...
public OnSettingChanged(Handle:convar, const String:oldValue[], const String:newValue[])
{
	...
	if(convar == g_hdist_wrecker_multibhop)
		g_dist_wrecker_multibhop = StringToFloat(newValue[0]);
	...
	if(convar == g_hdist_wrecker_bhop)
		g_dist_wrecker_bhop = StringToFloat(newValue[0]);
	...
	if(convar == g_hdist_wrecker_dropbhop)
		g_dist_wrecker_dropbhop = StringToFloat(newValue[0]);
	...
	if(convar == g_hdist_wrecker_weird)
		g_dist_wrecker_weird = StringToFloat(newValue[0]);
	...
	if(convar == g_hdist_wrecker_lj)
		g_dist_wrecker_lj = StringToFloat(newValue[0]);

	if(convar == g_hdist_good_ljcps)
		g_dist_good_ljcps = StringToFloat(newValue[0]);

	if(convar == g_hdist_pro_ljcps)
		g_dist_pro_ljcps = StringToFloat(newValue[0]);

	if(convar == g_hdist_leet_ljcps)
		g_dist_leet_ljcps = StringToFloat(newValue[0]);

	if(convar == g_hdist_ownage_ljcps)
		g_dist_ownage_ljcps = StringToFloat(newValue[0]);

	if(convar == g_hdist_wrecker_ljcps)
		g_dist_wrecker_ljcps = StringToFloat(newValue[0]);
...
public Action Command_Setljblock(int client, int args) 
{
...
public CenterHudAlive(client)  // Thx Exd for putting an arrow in the hud [ https://github.com/exd02 ]
{
	if (!IsValidClient(client))
		return;
	...
	if (g_bInfoPanel[client])
	{
		...
		new Buttons = g_LastButton[client];
		...
		float AngleDiff = Angle[1] - gF_OldAngle[client];

		if (Angle[1] - gF_OldAngle[client] > 180)
			AngleDiff -= 360;
		else if	(Angle[1] - gF_OldAngle[client] < -180)
			AngleDiff += 360;
		
		gF_OldAngle[client] = Angle[1];

		Format(sResult, sizeof(sResult), "%s\n             ", sResult);

		if (Buttons & IN_LEFT)
			Format(sResult, sizeof(sResult), "%s +L   ", sResult);
		else if (AngleDiff > 0)
			Format(sResult, sizeof(sResult), "%s ←   ", sResult);
		else if (Buttons & IN_RIGHT)
			Format(sResult, sizeof(sResult), "%s    +R", sResult);
		else if (AngleDiff < 0)
			Format(sResult, sizeof(sResult), "%s    →", sResult);

		if (IsValidEntity(client) && 1 <= client <= MaxClients)
			PrintHintText(client,"<pre><font color='%s'><b>Last Jump</b>: %s\n<b>Speed</b>: %.1f u/s (%.0f)\n%s</font></pre>",g_iHEX[g_iSpeedPanelColor[client]], g_js_szLastJumpDistance[client],g_fSpeed[client],g_js_fPreStrafe[client],sResult);
	}
}
...
public Function_BlockJump(client)
{
	...
	else
	{
		...
		PrintToChat(client, "%t", "LJblock1",PREFIXCOLOR,WHITE,RED);
	}
}
...
CalculateBlockGap(client, Float:origin[3], Float:target[3])
{
	...
	{
		g_bLJBlock[client] = false;
		PrintToChat(client, "%t", "LJblock2",PREFIXCOLOR,WHITE,RED);
		return;
	}
	...
	if (surface > 1000000)
	{
		PrintToChat(client, "%t", "LJblock3",PREFIXCOLOR,WHITE,RED);
		return;
	}
	...
	{
		g_bLJBlock[client] = false;
		PrintToChat(client, "%t", "LJblock4",PREFIXCOLOR,WHITE,RED);
		return;
	}
	...
	{
		PrintToChat(client, "%t", "LJblock5", PREFIXCOLOR,WHITE, LIMEGREEN,GREEN, g_BlockDist[client],LIMEGREEN);
		g_bLJBlock[client] = true;
	}
	else
	{
		if (g_BlockDist[client] < 225)
			PrintToChat(client, "%t", "LJblock6", PREFIXCOLOR,WHITE, RED,DARKRED,g_BlockDist[client],RED);
		else
			if (g_BlockDist[client] > 300)
				PrintToChat(client, "%t", "LJblock7", PREFIXCOLOR,WHITE, RED,DARKRED,g_BlockDist[client],RED);
	}
}
...
public Postthink(client) {
	...
	if (g_bStrafeSync[client] && strafes > 1)
	{
		...
		{
			if (i==0)
				Format(szStrafeSync, 255, "[%cKZ%c] %cSync:",PREFIXCOLOR,WHITE,WHITE);
			...
			if (i==0)
				Format(szStrafeSync2, 255, " %c%i.%c %i%c",WHITE, (i+1),LIMEGREEN,strafe_sync,PERCENT);
			else
				Format(szStrafeSync2, 255, "%c - %i.%c %i%c",WHITE, (i+1),LIMEGREEN,strafe_sync,PERCENT);
			StrCat(szStrafeSync, sizeof(szStrafeSync), szStrafeSync2);
			if ((i+1) == strafes)
			{
				Format(szStrafeSync2, 255, " %c[%c%i%c%c]",WHITE,PURPLE, sync,PERCENT,WHITE);
				StrCat(szStrafeSync, sizeof(szStrafeSync), szStrafeSync2);
			}
		}
	}
	...
	//new Buttons = g_LastButton[client];
	// ct jumpstats
	if((GetClientTeam(client) != CS_TEAM_T && g_iCtJumpstats == 1) && GameRules_GetProp("m_bWarmupPeriod") == 0)
	{
		Format(g_js_szLastJumpDistance[client], 256, "<font color='#ff0000'>Only T</font>");
		PostThinkPost(client, ground_frames);
		return;
	}
//	else if ((Buttons & IN_LEFT) || (Buttons & IN_RIGHT))
//	{
//		Format(g_js_szLastJumpDistance[client], 256, "<font color='#ff0000'>+L/+R BLOCK</font>");
//		PostThinkPost(client, ground_frames);
//		return;
//	}
	//vertical jump
	else if (fGroundDiff2 > 1.82 || fGroundDiff2 < -1.82 || fGroundDiff != 0.0)
	{
	...
	//invalid jump
	else if (g_fAirTime[client] > 0.83)
	{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//LongJump [P]
	g_js_fPreStrafe[client] = g_js_fPreStrafe[client]; //WHY IF WE REMOVE WE GOT AN ERROR? I DON'T KNOW.
	if (g_js_fPreStrafe[client] > 251.0)
	{
		if (ground_frames > 11 && fGroundDiff == 0.0 && fJump_Height <= 67.0 && g_js_fJump_Distance[client] < 300.0 && g_js_fMax_Speed_Final[client] > 200.0)
		{
			...
			if (g_js_fPreStrafe[client] > 279.0 || g_js_fPreStrafe[client] < 200.0)
			{
				if (g_js_fPreStrafe[client] < 251.0)
			...
			if(g_bLJBlock[client] && g_BlockDist[client] > 225 && g_js_fJump_Distance[client] >= float(g_BlockDist[client]))
			{
				if (g_bLJBlockValidJumpoff[client])
				{
					if (g_bLjStarDest[client])
					{
						...
						{
							Format(sBlockDist, 32, "%t", "LjBlock", WHITE,LIGHTYELLOW,g_BlockDist[client],WHITE);
			...
			ValidJump=true;
			//good?
			if (g_js_fJump_Distance[client] >= g_dist_good_ljcps && g_js_fJump_Distance[client] < g_dist_pro_ljcps)
			{
				...
				if (prestrafe)
					PrintToChat(client, "%t", "ClientLongJumpCPS1", PREFIXCOLOR,WHITE,GRAY, g_js_fJump_Distance[client],GRAY,strafes,WHITE, GRAY, g_js_fPreStrafe[client], WHITE,GRAY,g_js_fMax_Speed_Final[client],WHITE,GRAY, fJump_Height,WHITE,GRAY, sync,PERCENT,WHITE,sBlockDist);
				else
					PrintToChat(client, "%t", "ClientLongJumpCPS2", PREFIXCOLOR,WHITE,GRAY, g_js_fJump_Distance[client],GRAY,strafes,WHITE, GRAY, g_js_fPreStrafe[client], WHITE,GRAY,g_js_fMax_Speed_Final[client],WHITE,GRAY, fJump_Height,WHITE,GRAY, sync,PERCENT,WHITE,sBlockDist);

				PrintToConsole(client, "        ");
				PrintToConsole(client, "JS | %s jumped %0.4f units with a LongJump[P] [%i Strafes | %.3f %s | %.0f Max | Height %.1f | %i%c Sync]%s",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], szVr,g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT,sBlockDistCon);
				PrintToConsole(client, "%s", szStrafeStats);
			}
			else if (g_js_fJump_Distance[client] >= g_dist_pro_ljcps && g_js_fJump_Distance[client] < g_dist_leet_ljcps)
			{
				...
				PrintToConsole(client, "%s", szStrafeStats);
				if (prestrafe)
					PrintToChat(client, "%t", "ClientLongJumpCPS3",PREFIXCOLOR,WHITE,GREEN,WHITE,GREEN,g_js_fJump_Distance[client],WHITE,GREEN,strafes,WHITE,GREEN,g_js_fPreStrafe[client],WHITE,GREEN,g_js_fMax_Speed_Final[client],WHITE,GREEN, fJump_Height,WHITE,GREEN, sync,PERCENT,WHITE,sBlockDist);
				else
					PrintToChat(client, "%t", "ClientLongJumpCPS4",PREFIXCOLOR,WHITE,GREEN,WHITE,GREEN,g_js_fJump_Distance[client],WHITE,GREEN,strafes,WHITE,GREEN,g_js_fPreStrafe[client],WHITE,GREEN,g_js_fMax_Speed_Final[client],WHITE,GREEN, fJump_Height,WHITE,GREEN, sync,PERCENT,WHITE,sBlockDist);
				...
				for (new i = 1; i <= MaxClients; i++)
				{
					if (IsValidClient(i))
					{
						if (g_bColorChat[i] && i != client)
							PrintToChat(i, "%t", "Jumpstats_LjCPSAll",PREFIXCOLOR,WHITE,GREEN,szName, MOSSGREEN,GREEN, g_js_fJump_Distance[client],MOSSGREEN,GREEN,sBlockDist);
					}
				}
			}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//Wrecker
			else if (g_js_fJump_Distance[client] >= g_dist_wrecker_ljcps)
			{
				// strafe hack protection & Ladderbug fix. We'll only apply this to ownages since the types below aren't really impressive with ladderbugs :P
					if (strafes == 0 || g_js_fPreStrafe[client] > 279.0) {
						Format(g_js_szLastJumpDistance[client], 256, "<font color='#948d8d'>invalid</font>");
						PostThinkPost(client, ground_frames);
						return;
					}
				Format(g_js_szLastJumpDistance[client], 256, "<font color='#b903d8'><b>%.2f units</b></font>", g_js_fJump_Distance[client]);
				g_js_WreckerJump_Count[client]++;
				CreateTimer(0.1, BhopCheck, client,TIMER_FLAG_NO_MAPCHANGE);
				//chat & sound client
				PrintToConsole(client, "        ");
				PrintToConsole(client, "JS | %s jumped %0.4f units with a LongJump[P] [%i Strafes | %.3f %s | %.0f Max | Height %.1f | %i%c Sync]%s",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client],szVr, g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT,sBlockDistCon);
				PrintToConsole(client, "%s", szStrafeStats);
				if (prestrafe)
					PrintToChat(client, "%t", "ClientLongJumpCPS3",PREFIXCOLOR,WHITE,PINK,WHITE,PINK,g_js_fJump_Distance[client],WHITE,PINK,strafes,WHITE,PINK,g_js_fPreStrafe[client],WHITE,PINK,g_js_fMax_Speed_Final[client],WHITE,PINK, fJump_Height,WHITE,PINK, sync,PERCENT,WHITE,sBlockDist);
				else
					PrintToChat(client, "%t", "ClientLongJumpCPS4",PREFIXCOLOR,WHITE,PINK,WHITE,PINK,g_js_fJump_Distance[client],WHITE,PINK,strafes,WHITE,PINK,g_js_fPreStrafe[client],WHITE,PINK,g_js_fMax_Speed_Final[client],WHITE,PINK, fJump_Height,WHITE,PINK, sync,PERCENT,WHITE,sBlockDist);
				if (g_js_WreckerJump_Count[client]==3)
					PrintToChat(client, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
				else
					if (g_js_WreckerJump_Count[client]==5)
						PrintToChat(client, "%t", "Jumpstats_IsCombowhore",PREFIXCOLOR,WHITE,PINK,szName);

				decl String:buffer[255];
				Format(buffer, sizeof(buffer), "play %s", WRECKERJUMP_RELATIVE_SOUND_PATH);
				if (g_bEnableQuakeSounds[client])
					ClientCommand(client, buffer);
				//chat all
				for (new i = 1; i <= MaxClients; i++)
				{
					if (IsValidClient(i))
					{
						if (g_bColorChat[i] && i != client)
						{
							PrintToChat(i, "%t", "Jumpstats_LjCPSAll",PREFIXCOLOR,WHITE,PINK,szName, PURPLE,PINK, g_js_fJump_Distance[client],PURPLE,PINK,sBlockDist);
							if (g_js_WreckerJump_Count[client]==3)
								PrintToChat(i, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
							else
								if (g_js_WreckerJump_Count[client]==5)
									PrintToChat(i, "%t", "Jumpstats_IsCombowhore",PREFIXCOLOR,WHITE,PINK,szName);
						}
					}
				}
						PlayWreckerJumpSound(client);
						if (g_js_WreckerJump_Count[client] != 3 && g_js_WreckerJump_Count[client] != 5) {
							for (new i = 1; i <= MaxClients+1; i++) { 
								if(IsValidClient(i) && !IsFakeClient(i) && g_bEnableQuakeSounds[i]) {
									ClientCommand(i, "play %s", WRECKERJUMP_RELATIVE_SOUND_PATH);
								}
							}
						}
				else
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//ownage?
			else if (g_js_fJump_Distance[client] >= g_dist_ownage_ljcps && g_js_fJump_Distance[client] <= g_dist_wrecker_ljcps && g_js_fMax_Speed_Final[client] > 275.0)
			{
				// strafe hack protection & Ladderbug fix. We'll only apply this to ownages since the types below aren't really impressive with ladderbugs :P
					if (strafes == 0 || g_js_fPreStrafe[client] > 279.0) {
						Format(g_js_szLastJumpDistance[client], 256, "<font color='#948d8d'>invalid</font>");
				...
				//client
				PrintToConsole(client, "        ");
				PrintToConsole(client, "JS | %s jumped %0.4f units with a LongJump[P] [%i Strafes | %.3f %s | %.3f Max | Height %.1f | %i%c Sync]%s",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client],szVr, g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT,sBlockDistCon);
				PrintToConsole(client, "%s", szStrafeStats);
				if (prestrafe)
					PrintToChat(client, "%t", "ClientLongJumpCPS3",PREFIXCOLOR,WHITE,YELLOW,WHITE,YELLOW,g_js_fJump_Distance[client],WHITE,YELLOW,strafes,WHITE,YELLOW,g_js_fPreStrafe[client],WHITE,YELLOW, g_js_fMax_Speed_Final[client],WHITE,YELLOW, fJump_Height,WHITE,YELLOW, sync,PERCENT,WHITE,sBlockDist);
				else
					PrintToChat(client, "%t", "ClientLongJumpCPS4",PREFIXCOLOR,WHITE,YELLOW,WHITE,YELLOW,g_js_fJump_Distance[client],WHITE,YELLOW,strafes,WHITE,YELLOW,g_js_fPreStrafe[client],WHITE,YELLOW, g_js_fMax_Speed_Final[client],WHITE,YELLOW, fJump_Height,WHITE,YELLOW, sync,PERCENT,WHITE,sBlockDist);
				if (g_js_OwnageJump_Count[client]==3)
					PrintToChat(client, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
				else
					if (g_js_OwnageJump_Count[client]==5)
						PrintToChat(client, "%t", "Jumpstats_IsWickedSick",PREFIXCOLOR,WHITE,YELLOW,szName);
				...
				for (new i = 1; i <= MaxClients; i++)
				{
					if (IsValidClient(i))
					{
						if (g_bColorChat[i] && i != client)
						{
							PrintToChat(i, "%t", "Jumpstats_LjCPSAll",PREFIXCOLOR,WHITE,YELLOW,szName, LIGHTYELLOW,YELLOW, g_js_fJump_Distance[client],LIGHTYELLOW,YELLOW,sBlockDist);
							if (g_js_OwnageJump_Count[client]==3)
								PrintToChat(i, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
							else
								if (g_js_OwnageJump_Count[client]==5)
									PrintToChat(i, "%t", "Jumpstats_IsWickedSick",PREFIXCOLOR,WHITE,YELLOW,szName);
						}
					}
				}
			...
			//leet?
				...
				if (g_js_fJump_Distance[client] >= g_dist_leet_ljcps && g_js_fMax_Speed_Final[client] > 275.0)
				{
					...
					PrintToConsole(client, "%s", szStrafeStats);
					if (prestrafe)
						PrintToChat(client, "%t", "ClientLongJumpCPS3",PREFIXCOLOR,WHITE,DARKRED,WHITE,DARKRED,g_js_fJump_Distance[client],WHITE,DARKRED,strafes,WHITE,DARKRED,g_js_fPreStrafe[client],WHITE,DARKRED, g_js_fMax_Speed_Final[client],WHITE,DARKRED, fJump_Height,WHITE,DARKRED, sync,PERCENT,WHITE,sBlockDist);
					else
						PrintToChat(client, "%t", "ClientLongJumpCPS4",PREFIXCOLOR,WHITE,DARKRED,WHITE,DARKRED,g_js_fJump_Distance[client],WHITE,DARKRED,strafes,WHITE,DARKRED,g_js_fPreStrafe[client],WHITE,DARKRED, g_js_fMax_Speed_Final[client],WHITE,DARKRED, fJump_Height,WHITE,DARKRED, sync,PERCENT,WHITE,sBlockDist);
					if (g_js_LeetJump_Count[client]==3)
						PrintToChat(client, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
					else
						if (g_js_LeetJump_Count[client]==5)
							PrintToChat(client, "%t", "Jumpstats_IsDominating",PREFIXCOLOR,WHITE,DARKRED,szName);
					...
					for (new i = 1; i <= MaxClients; i++)
					{
						if (IsValidClient(i))
						{
							if (g_bColorChat[i] && i != client)
							{
								PrintToChat(i, "%t", "Jumpstats_LjCPSAll",PREFIXCOLOR,WHITE,DARKRED,szName, RED,DARKRED, g_js_fJump_Distance[client],RED,DARKRED,sBlockDist);
								if (g_js_LeetJump_Count[client]==3)
									PrintToChat(i, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
								else
									if (g_js_LeetJump_Count[client]==5)
										PrintToChat(i, "%t", "Jumpstats_IsDominating",PREFIXCOLOR,WHITE,DARKRED,szName);
							}
						}
					}
			...
			//new best
			if (((g_js_fPersonal_LjCps_Record[client] < g_js_fJump_Distance[client]) || (ljblock && g_js_Personal_LjCpsBlock_Record[client] < g_BlockDist[client]) || (ljblock && g_js_Personal_LjCpsBlock_Record[client] == g_BlockDist[client] && g_js_fPersonal_LjCpsBlockRecord_Dist[client] < g_js_fJump_Distance[client])) && !IsFakeClient(client))
			{
				if (ValidJump)
				{
					if (g_js_fPersonal_LjCps_Record[client] > 0.0 && g_js_fPersonal_LjCps_Record[client] < g_js_fJump_Distance[client])
						PrintToChat(client, "%t", "Jumpstats_BeatLjCPSBest",PREFIXCOLOR,WHITE,LIGHTBLUE, g_js_fJump_Distance[client]);
					if (ljblock && g_js_Personal_LjCpsBlock_Record[client] > 0 && ((g_js_Personal_LjCpsBlock_Record[client] < g_BlockDist[client]) || (g_js_Personal_LjCpsBlock_Record[client] == g_BlockDist[client] && g_js_fPersonal_LjCpsBlockRecord_Dist[client] < g_js_fJump_Distance[client])))
						PrintToChat(client, "%t", "Jumpstats_BeatLjCPSBlockBest",PREFIXCOLOR,WHITE,LIGHTBLUE, g_BlockDist[client],g_js_fJump_Distance[client]);
					if (g_js_fPersonal_LjCps_Record[client] < g_js_fJump_Distance[client])
					{
						g_js_fPersonal_LjCps_Record[client] = g_js_fJump_Distance[client];
						db_updateLjCPSRecord(client);
					}
					if (g_js_Personal_LjCpsBlock_Record[client] < g_BlockDist[client] && ljblock || (ljblock && g_js_Personal_LjCpsBlock_Record[client] == g_BlockDist[client] && g_js_fPersonal_LjCpsBlockRecord_Dist[client] < g_js_fJump_Distance[client]))
					{
						g_js_Personal_LjCpsBlock_Record[client] = g_BlockDist[client];
						g_js_fPersonal_LjCpsBlockRecord_Dist[client] = g_js_fJump_Distance[client];
						db_updateLjCPSBlockRecord(client);
					}
				}
			}
		}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (ground_frames > 11 && fGroundDiff == 0.0 && fJump_Height <= 67.0 && g_js_fJump_Distance[client] < 300.0 && g_js_fMax_Speed_Final[client] > 200.0)
	{
		...
		prestrafe = true;
		//strafe hack block (aimware is pretty smart :/) (2/2)
		if (g_js_fPreStrafe[client] > 251.0 || g_js_fPreStrafe[client] < 200.0)
		{
		...
		if (g_js_fJump_Distance[client] >= g_dist_good_lj && g_js_fJump_Distance[client] < g_dist_pro_lj)
		{
			...
			CreateTimer(0.1, BhopCheck, client,TIMER_FLAG_NO_MAPCHANGE);
			if (prestrafe)
				PrintToChat(client, "%t", "ClientLongJump1", PREFIXCOLOR,WHITE,GRAY, g_js_fJump_Distance[client],GRAY,strafes,WHITE, GRAY, g_js_fPreStrafe[client], WHITE,GRAY,g_js_fMax_Speed_Final[client],WHITE,GRAY, fJump_Height,WHITE,GRAY, sync,PERCENT,WHITE,sBlockDist);
			else
				PrintToChat(client, "%t", "ClientLongJump2", PREFIXCOLOR,WHITE,GRAY, g_js_fJump_Distance[client],GRAY,strafes,WHITE, GRAY, g_js_fPreStrafe[client], WHITE,GRAY,g_js_fMax_Speed_Final[client],WHITE,GRAY, fJump_Height,WHITE,GRAY, sync,PERCENT,WHITE,sBlockDist);
		...
		else if (g_js_fJump_Distance[client] >= g_dist_pro_lj && g_js_fJump_Distance[client] < g_dist_leet_lj)
		{
			...
			PrintToConsole(client, "%s", szStrafeStats);
			if (prestrafe)
				PrintToChat(client, "%t", "ClientLongJump3",PREFIXCOLOR,WHITE,GREEN,WHITE,GREEN,g_js_fJump_Distance[client],WHITE,GREEN,strafes,WHITE,GREEN,g_js_fPreStrafe[client],WHITE,GREEN,g_js_fMax_Speed_Final[client],WHITE,GREEN, fJump_Height,WHITE,GREEN, sync,PERCENT,WHITE,sBlockDist);
			else
				PrintToChat(client, "%t", "ClientLongJump4",PREFIXCOLOR,WHITE,GREEN,WHITE,GREEN,g_js_fJump_Distance[client],WHITE,GREEN,strafes,WHITE,GREEN,g_js_fPreStrafe[client],WHITE,GREEN,g_js_fMax_Speed_Final[client],WHITE,GREEN, fJump_Height,WHITE,GREEN, sync,PERCENT,WHITE,sBlockDist);
			...
			for (new i = 1; i <= MaxClients; i++)
			{
				...
				{
					if (g_bColorChat[i] && i != client)
						PrintToChat(i, "%t", "Jumpstats_LjAll",PREFIXCOLOR,WHITE,GREEN,szName, MOSSGREEN,GREEN, g_js_fJump_Distance[client],MOSSGREEN,GREEN,sBlockDist);
				}
			}
		}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//Wrecker
		else if (g_js_fJump_Distance[client] >= g_dist_wrecker_lj)
		{
			// strafe hack protection & Ladderbug fix. We'll only apply this to ownages since the types below aren't really impressive with ladderbugs :P
				if (strafes == 0 || g_js_fPreStrafe[client] > 251.0 || g_js_fPreStrafe[client] < 240.0) {
					Format(g_js_szLastJumpDistance[client], 256, "<font color='#948d8d'>invalid</font>");
					PostThinkPost(client, ground_frames);
					return;
				}
			...
			PrintToConsole(client, "%s", szStrafeStats);
			if (prestrafe)
				PrintToChat(client, "%t", "ClientLongJump3",PREFIXCOLOR,WHITE,PINK,WHITE,PINK,g_js_fJump_Distance[client],WHITE,PINK,strafes,WHITE,PINK,g_js_fPreStrafe[client],WHITE,PINK,g_js_fMax_Speed_Final[client],WHITE,PINK, fJump_Height,WHITE,PINK, sync,PERCENT,WHITE,sBlockDist);
			else
				PrintToChat(client, "%t", "ClientLongJump4",PREFIXCOLOR,WHITE,PINK,WHITE,PINK,g_js_fJump_Distance[client],WHITE,PINK,strafes,WHITE,PINK,g_js_fPreStrafe[client],WHITE,PINK,g_js_fMax_Speed_Final[client],WHITE,PINK, fJump_Height,WHITE,PINK, sync,PERCENT,WHITE,sBlockDist);
			if (g_js_WreckerJump_Count[client]==3)
				PrintToChat(client, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
			else
				if (g_js_WreckerJump_Count[client]==5)
			...
			for (new i = 1; i <= MaxClients; i++)
			{
				if (IsValidClient(i))
				{
					if (g_bColorChat[i] && i != client)
					{
						PrintToChat(i, "%t", "Jumpstats_LjAll",PREFIXCOLOR,WHITE,PINK,szName, PURPLE,PINK, g_js_fJump_Distance[client],PURPLE,PINK,sBlockDist);
						if (g_js_WreckerJump_Count[client]==3)
							PrintToChat(i, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
						else
							if (g_js_WreckerJump_Count[client]==5)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//ownage?
		else if (g_js_fJump_Distance[client] >= g_dist_ownage_lj && g_js_fJump_Distance[client] <= g_dist_wrecker_lj && g_js_fMax_Speed_Final[client] > 275.0)
		{
			// strafe hack protection & Ladderbug fix. We'll only apply this to ownages since the types below aren't really impressive with ladderbugs :P
				if (strafes == 0 || g_js_fPreStrafe[client] > 251.0 || g_js_fPreStrafe[client] < 240.0) {
					Format(g_js_szLastJumpDistance[client], 256, "<font color='#948d8d'>invalid</font>");
			...
			PrintToConsole(client, "%s", szStrafeStats);
			if (prestrafe)
				PrintToChat(client, "%t", "ClientLongJump3",PREFIXCOLOR,WHITE,YELLOW,WHITE,YELLOW,g_js_fJump_Distance[client],WHITE,YELLOW,strafes,WHITE,YELLOW,g_js_fPreStrafe[client],WHITE,YELLOW, g_js_fMax_Speed_Final[client],WHITE,YELLOW, fJump_Height,WHITE,YELLOW, sync,PERCENT,WHITE,sBlockDist);
			else
				PrintToChat(client, "%t", "ClientLongJump4",PREFIXCOLOR,WHITE,YELLOW,WHITE,YELLOW,g_js_fJump_Distance[client],WHITE,YELLOW,strafes,WHITE,YELLOW,g_js_fPreStrafe[client],WHITE,YELLOW, g_js_fMax_Speed_Final[client],WHITE,YELLOW, fJump_Height,WHITE,YELLOW, sync,PERCENT,WHITE,sBlockDist);
			if (g_js_OwnageJump_Count[client]==3)
				PrintToChat(client, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
			else
				if (g_js_OwnageJump_Count[client]==5)
			...
			for (new i = 1; i <= MaxClients; i++)
			{
				if (IsValidClient(i))
				{
					if (g_bColorChat[i] && i != client)
					{
						PrintToChat(i, "%t", "Jumpstats_LjAll",PREFIXCOLOR,WHITE,YELLOW,szName, LIGHTYELLOW,YELLOW, g_js_fJump_Distance[client],LIGHTYELLOW,YELLOW,sBlockDist);
						if (g_js_OwnageJump_Count[client]==3)
							PrintToChat(i, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
						else
							if (g_js_OwnageJump_Count[client]==5)
		...
		//leet?
			...
			if (g_js_fJump_Distance[client] >= g_dist_leet_lj && g_js_fMax_Speed_Final[client] > 275.0)
			{
				...
				PrintToConsole(client, "%s", szStrafeStats);
				if (prestrafe)
					PrintToChat(client, "%t", "ClientLongJump3",PREFIXCOLOR,WHITE,DARKRED,WHITE,DARKRED,g_js_fJump_Distance[client],WHITE,DARKRED,strafes,WHITE,DARKRED,g_js_fPreStrafe[client],WHITE,DARKRED, g_js_fMax_Speed_Final[client],WHITE,DARKRED, fJump_Height,WHITE,DARKRED, sync,PERCENT,WHITE,sBlockDist);
				else
					PrintToChat(client, "%t", "ClientLongJump4",PREFIXCOLOR,WHITE,DARKRED,WHITE,DARKRED,g_js_fJump_Distance[client],WHITE,DARKRED,strafes,WHITE,DARKRED,g_js_fPreStrafe[client],WHITE,DARKRED, g_js_fMax_Speed_Final[client],WHITE,DARKRED, fJump_Height,WHITE,DARKRED, sync,PERCENT,WHITE,sBlockDist);
				if (g_js_LeetJump_Count[client]==3)
					PrintToChat(client, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
				else
					if (g_js_LeetJump_Count[client]==5)
				...
				for (new i = 1; i <= MaxClients; i++)
				{
					if (IsValidClient(i))
					{
						if (g_bColorChat[i] && i != client)
						{
							PrintToChat(i, "%t", "Jumpstats_LjAll",PREFIXCOLOR,WHITE,DARKRED,szName, RED,DARKRED, g_js_fJump_Distance[client],RED,DARKRED,sBlockDist);
							if (g_js_LeetJump_Count[client]==3)
								PrintToChat(i, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
							else
								if (g_js_LeetJump_Count[client]==5)
		...
		if (((g_js_fPersonal_Lj_Record[client] < g_js_fJump_Distance[client]) || (ljblock && g_js_Personal_LjBlock_Record[client] < g_BlockDist[client]) || (ljblock && g_js_Personal_LjBlock_Record[client] == g_BlockDist[client] && g_js_fPersonal_LjBlockRecord_Dist[client] < g_js_fJump_Distance[client])) && !IsFakeClient(client))
		{
			if (ValidJump)
			{
				if (g_js_fPersonal_Lj_Record[client] > 0.0 && g_js_fPersonal_Lj_Record[client] < g_js_fJump_Distance[client])
					PrintToChat(client, "%t", "Jumpstats_BeatLjBest",PREFIXCOLOR,WHITE,LIGHTBLUE, g_js_fJump_Distance[client]);
				if (ljblock && g_js_Personal_LjBlock_Record[client] > 0 && ((g_js_Personal_LjBlock_Record[client] < g_BlockDist[client]) || (g_js_Personal_LjBlock_Record[client] == g_BlockDist[client] && g_js_fPersonal_LjBlockRecord_Dist[client] < g_js_fJump_Distance[client])))
					PrintToChat(client, "%t", "Jumpstats_BeatLjBlockBest",PREFIXCOLOR,WHITE,LIGHTBLUE, g_BlockDist[client],g_js_fJump_Distance[client]);
	...
	if (g_js_Last_Ground_Frames[client] < 11 && ground_frames < 11 && fGroundDiff == 0.0  && fJump_Height <= 67.0 && !g_js_bDropJump[client])
	{
		...
		if (g_js_fJump_Distance[client] >= g_dist_good_multibhop && g_js_fJump_Distance[client] < g_dist_pro_multibhop)
		{
			Format(g_js_szLastJumpDistance[client], 256, "<font color='#676060'><b>%.1f units</b></font>", g_js_fJump_Distance[client]);
			g_js_LeetJump_Count[client]=0;
			PrintToChat(client, "%t", "ClientMultiBhop1",PREFIXCOLOR,WHITE, GRAY, g_js_fJump_Distance[client],GRAY, strafes, WHITE, GRAY, g_js_fPreStrafe[client], WHITE, GRAY, sync,PERCENT,WHITE);
			PrintToConsole(client, "        ");
			...
			if (g_js_fJump_Distance[client] >= g_dist_pro_multibhop && g_js_fJump_Distance[client] < g_dist_leet_multibhop)
			{
				...
				PrintToConsole(client, "%s", szStrafeStats);
				PrintToChat(client, "%t", "ClientMultiBhop2",PREFIXCOLOR,WHITE,GREEN,WHITE,GREEN,g_js_fJump_Distance[client],WHITE,GREEN,strafes,WHITE,GREEN,g_js_fPreStrafe[client],WHITE,GREEN,g_js_fMax_Speed_Final[client],WHITE,GREEN, fJump_Height,WHITE, GREEN,szBhopCount,WHITE,GREEN, sync,PERCENT,WHITE);
				...
				for (new i = 1; i <= MaxClients; i++)
				{
					...
					{
						if (g_bColorChat[i] && i != client)
							PrintToChat(i, "%t", "Jumpstats_MultiBhopAll",PREFIXCOLOR,WHITE,GREEN,szName, MOSSGREEN,GREEN, g_js_fJump_Distance[client],MOSSGREEN,GREEN);
					}
				}
			}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (g_js_fJump_Distance[client] >= g_dist_wrecker_multibhop)
			{
				...
				PrintToConsole(client, "JS | %s jumped %0.4f units with a MultiBhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %s Bhops | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client], fJump_Height,szBhopCount,sync,PERCENT);
				PrintToConsole(client, "%s", szStrafeStats);
				PrintToChat(client, "%t", "ClientMultiBhop2",PREFIXCOLOR,WHITE,PINK,WHITE,PINK,g_js_fJump_Distance[client],WHITE,PINK,strafes,WHITE,PINK,g_js_fPreStrafe[client],WHITE,PINK,g_js_fMax_Speed_Final[client],WHITE,PINK, fJump_Height,WHITE, PINK,szBhopCount,WHITE,PINK, sync,PERCENT,WHITE);
				if (g_js_WreckerJump_Count[client]==3)
					PrintToChat(client, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
				else
				if (g_js_WreckerJump_Count[client]==5)
				...
				for (new i = 1; i <= MaxClients; i++)
				{
					if (IsValidClient(i))
					{
						if (g_bColorChat[i] && i != client)
						{
							PrintToChat(i, "%t", "Jumpstats_MultiBhopAll",PREFIXCOLOR,WHITE,PINK,szName, PURPLE,PINK, g_js_fJump_Distance[client],PURPLE,PINK);
							if (g_js_WreckerJump_Count[client]==3)
									PrintToChat(i, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
								else
								if (g_js_WreckerJump_Count[client]==5)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (g_js_fJump_Distance[client] >= g_dist_ownage_multibhop && g_js_fJump_Distance[client] < g_dist_wrecker_multibhop)
			{
				// strafe hack protection
				if (strafes == 0 || g_js_fPreStrafe[client] < 270.0)
				{
				...
				PrintToConsole(client, "JS | %s jumped %0.4f units with a MultiBhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %s Bhops | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client], fJump_Height,szBhopCount,sync,PERCENT);
				PrintToConsole(client, "%s", szStrafeStats);
				PrintToChat(client, "%t", "ClientMultiBhop2",PREFIXCOLOR,WHITE,YELLOW,WHITE,YELLOW,g_js_fJump_Distance[client],WHITE,YELLOW,strafes,WHITE,YELLOW,g_js_fPreStrafe[client],WHITE,YELLOW,g_js_fMax_Speed_Final[client],WHITE,YELLOW, fJump_Height,WHITE, YELLOW,szBhopCount,WHITE,YELLOW, sync,PERCENT,WHITE);
				if (g_js_OwnageJump_Count[client]==3)
					PrintToChat(client, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
				else
				if (g_js_OwnageJump_Count[client]==5)
				...
				for (new i = 1; i <= MaxClients; i++)
				{
					if (IsValidClient(i))
					{
						if (g_bColorChat[i] && i != client)
						{
							PrintToChat(i, "%t", "Jumpstats_MultiBhopAll",PREFIXCOLOR,WHITE,YELLOW,szName, LIGHTYELLOW,YELLOW, g_js_fJump_Distance[client],LIGHTYELLOW,YELLOW);
							if (g_js_OwnageJump_Count[client]==3)
									PrintToChat(i, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
								else
								if (g_js_OwnageJump_Count[client]==5)
			...
			if (g_js_fJump_Distance[client] >= g_dist_leet_multibhop)
			{
				...
				PrintToConsole(client, "JS | %s jumped %0.4f units with a MultiBhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %s Bhops | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client], fJump_Height,szBhopCount,sync,PERCENT);
				PrintToConsole(client, "%s", szStrafeStats);
				PrintToChat(client, "%t", "ClientMultiBhop2",PREFIXCOLOR,WHITE,DARKRED,WHITE,DARKRED,g_js_fJump_Distance[client],WHITE,DARKRED,strafes,WHITE,DARKRED,g_js_fPreStrafe[client],WHITE,DARKRED,g_js_fMax_Speed_Final[client],WHITE,DARKRED, fJump_Height,WHITE, DARKRED,szBhopCount,WHITE,DARKRED, sync,PERCENT,WHITE);
				if (g_js_LeetJump_Count[client]==3)
					PrintToChat(client, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
				else
				if (g_js_LeetJump_Count[client]==5)
				...
				for (new i = 1; i <= MaxClients; i++)
				{
					if (IsValidClient(i))
					{
						if (g_bColorChat[i] && i != client)
						{
							PrintToChat(i, "%t", "Jumpstats_MultiBhopAll",PREFIXCOLOR,WHITE,DARKRED,szName, RED,DARKRED, g_js_fJump_Distance[client],RED,DARKRED);
							if (g_js_LeetJump_Count[client]==3)
									PrintToChat(i, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
								else
								if (g_js_LeetJump_Count[client]==5)
		...
		if (g_js_fPersonal_MultiBhop_Record[client] < g_js_fJump_Distance[client] &&  !IsFakeClient(client) && ValidJump)
		{
			if (g_js_fPersonal_MultiBhop_Record[client] > 0.0)
				PrintToChat(client, "%t", "Jumpstats_BeatMultiBhopBest",PREFIXCOLOR,WHITE,LIGHTBLUE, g_js_fJump_Distance[client]);
	...
	if (ground_frames < 11 && g_js_Last_Ground_Frames[client] > 11 && g_bLastButtonJump[client] && fGroundDiff == 0.0 && fJump_Height <= 67.0 && g_js_bDropJump[client])
	{
		if (g_js_fDropped_Units[client] > 150.0)
		{
			if (g_js_fDropped_Units[client] < 300.0)
				PrintToChat(client, "%t", "DropBhop1",PREFIXCOLOR,WHITE,RED,g_js_fDropped_Units[client],WHITE,GREEN,WHITE,WHITE,WHITE);
		}
		else
		{
			Format(g_js_szLastJumpDistance[client], 256, "<font color='#948d8d'>%.1f units</font>", g_js_fJump_Distance[client]);
			...
			if (g_js_fJump_Distance[client] >= g_dist_good_dropbhop && g_js_fJump_Distance[client] < g_dist_pro_dropbhop)
			{
				Format(g_js_szLastJumpDistance[client], 256, "<font color='#676060'><b>%.1f units</b></font>", g_js_fJump_Distance[client]);
				g_js_LeetJump_Count[client]=0;
				PrintToChat(client, "%t", "ClientDropBhop1",PREFIXCOLOR,WHITE, GRAY,g_js_fJump_Distance[client],GRAY, strafes, WHITE, GRAY, g_js_fPreStrafe[client], WHITE, GRAY,fJump_Height,WHITE, GRAY,sync,PERCENT,WHITE);
				PrintToConsole(client, "        ");
				...
				if (g_js_fJump_Distance[client] >= g_dist_pro_dropbhop && g_js_fJump_Distance[client] < g_dist_leet_dropbhop)
				{
					...
					Format(g_js_szLastJumpDistance[client], 256, "<font color='#21982a'><b>%.2f units</b></font>", g_js_fJump_Distance[client]);
					PrintToConsole(client, "        ");
					PrintToChat(client, "%t", "ClientDropBhop2",PREFIXCOLOR,WHITE,GREEN,WHITE,GREEN,g_js_fJump_Distance[client],WHITE,GREEN,strafes,WHITE,GREEN,g_js_fPreStrafe[client],WHITE,GREEN, g_js_fMax_Speed_Final[client],WHITE,GREEN, fJump_Height,WHITE, GREEN,sync,PERCENT,WHITE);
					PrintToConsole(client, "JS | %s jumped %0.4f units with a DropBhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT);
					PrintToConsole(client, "%s", szStrafeStats);
					decl String:buffer[255];
					Format(buffer, sizeof(buffer), "play %s", PROJUMP_RELATIVE_SOUND_PATH);
					...
					for (new i = 1; i <= MaxClients; i++)
					{
						if (IsValidClient(i))
						{
							if (g_bColorChat[i]==true && i != client)
								PrintToChat(i, "%t", "Jumpstats_DropBhopAll",PREFIXCOLOR,WHITE,GREEN,szName, MOSSGREEN,GREEN, g_js_fJump_Distance[client],MOSSGREEN,GREEN);
						}
					}
				}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				//Wrecker
					...
					if (g_js_fJump_Distance[client] >= g_dist_wrecker_dropbhop && g_js_fMax_Speed_Final[client] > 330.0)
					{
						// strafe hack protection
						if (strafes == 0 || g_js_fPreStrafe[client] < 270.0)
						{
						...
						//Client
						PrintToConsole(client, "        ");
						PrintToChat(client, "%t", "ClientDropBhop2",PREFIXCOLOR,WHITE,PINK,WHITE,PINK,g_js_fJump_Distance[client],WHITE,PINK,strafes,WHITE,PINK,g_js_fPreStrafe[client],WHITE,PINK, g_js_fMax_Speed_Final[client],WHITE,PINK,fJump_Height,WHITE, PINK, sync,PERCENT,WHITE);
						PrintToConsole(client, "JS | %s jumped %0.4f units with a DropBhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT);
						PrintToConsole(client, "%s", szStrafeStats);
						if (g_js_WreckerJump_Count[client]==3)
							PrintToChat(client, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
						...
						for (new i = 1; i <= MaxClients; i++)
						{
							if (IsValidClient(i))
							{
								if (g_bColorChat[i]==true && i != client)
								{
									PrintToChat(i, "%t", "Jumpstats_DropBhopAll",PREFIXCOLOR,WHITE,PINK,szName, PURPLE,PINK, g_js_fJump_Distance[client], PURPLE,PINK);
									if (g_js_WreckerJump_Count[client]==3)
											PrintToChat(i, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
									else
										if (g_js_WreckerJump_Count[client]==5)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				//ownage?
					...
					if (g_js_fJump_Distance[client] >= g_dist_ownage_dropbhop && g_js_fJump_Distance[client] < g_dist_wrecker_dropbhop && g_js_fMax_Speed_Final[client] > 330.0)
					{
						// strafe hack protection
						if (strafes == 0 || g_js_fPreStrafe[client] < 270.0)
						{
						...
						//Client
						PrintToConsole(client, "        ");
						PrintToChat(client, "%t", "ClientDropBhop2",PREFIXCOLOR,WHITE,YELLOW,WHITE,YELLOW,g_js_fJump_Distance[client],WHITE,YELLOW,strafes,WHITE,YELLOW,g_js_fPreStrafe[client],WHITE,YELLOW, g_js_fMax_Speed_Final[client],WHITE,YELLOW,fJump_Height,WHITE, YELLOW, sync,PERCENT,WHITE);
						PrintToConsole(client, "JS | %s jumped %0.4f units with a DropBhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT);
						PrintToConsole(client, "%s", szStrafeStats);
						if (g_js_OwnageJump_Count[client]==3)
							PrintToChat(client, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
						...
						for (new i = 1; i <= MaxClients; i++)
						{
							if (IsValidClient(i))
							{
								if (g_bColorChat[i]==true && i != client)
								{
									PrintToChat(i, "%t", "Jumpstats_DropBhopAll",PREFIXCOLOR,WHITE,YELLOW,szName, LIGHTYELLOW,YELLOW, g_js_fJump_Distance[client], LIGHTYELLOW,YELLOW);
									if (g_js_OwnageJump_Count[client]==3)
											PrintToChat(i, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
									else
										if (g_js_OwnageJump_Count[client]==5)
				...
				//leet
					...
					if (g_js_fJump_Distance[client] >= g_dist_leet_dropbhop  && g_js_fMax_Speed_Final[client] > 330.0)
					{
						...
						//Client
						PrintToConsole(client, "        ");
						PrintToChat(client, "%t", "ClientDropBhop2",PREFIXCOLOR,WHITE,DARKRED,WHITE,DARKRED,g_js_fJump_Distance[client],WHITE,DARKRED,strafes,WHITE,DARKRED,g_js_fPreStrafe[client],WHITE,DARKRED, g_js_fMax_Speed_Final[client],WHITE,DARKRED,fJump_Height,WHITE, DARKRED, sync,PERCENT,WHITE);
						PrintToConsole(client, "JS | %s jumped %0.4f units with a DropBhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT);
						PrintToConsole(client, "%s", szStrafeStats);
						if (g_js_LeetJump_Count[client]==3)
							PrintToChat(client, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,YELLOW,szName);
						else
							if (g_js_LeetJump_Count[client]==5)
								PrintToChat(client, "%t", "Jumpstats_IsDominating",PREFIXCOLOR,WHITE,YELLOW,szName);
						...
						for (new i = 1; i <= MaxClients; i++)
						{
							if (IsValidClient(i))
							{
								if (g_bColorChat[i]==true && i != client)
								{
									PrintToChat(i, "%t", "Jumpstats_DropBhopAll",PREFIXCOLOR,WHITE,DARKRED,szName, RED,DARKRED, g_js_fJump_Distance[client], RED,DARKRED);
									if (g_js_LeetJump_Count[client]==3)
											PrintToChat(i, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,YELLOW,szName);
									else
										if (g_js_LeetJump_Count[client]==5)
											PrintToChat(i, "%t", "Jumpstats_IsDominating",PREFIXCOLOR,WHITE,YELLOW,szName);
								}
							}
						}
						PlayLeetJumpSound(client);
			...
			if (g_js_fPersonal_DropBhop_Record[client] < g_js_fJump_Distance[client]  &&  !IsFakeClient(client) && ValidJump)
			{
				if (g_js_fPersonal_DropBhop_Record[client] > 0.0)
					PrintToChat(client, "%t", "Jumpstats_BeatDropBhopBest",PREFIXCOLOR,WHITE,LIGHTBLUE, g_js_fJump_Distance[client]);
	...
	if (ground_frames < 11 && !g_bLastButtonJump[client] && fGroundDiff == 0.0 && fJump_Height <= 67.0 && g_js_bDropJump[client])
	{
			...
			{
				if (g_js_fDropped_Units[client] < 300.0)
					PrintToChat(client, "%t", "Wj1",PREFIXCOLOR,WHITE,RED,g_js_fDropped_Units[client],WHITE,GREEN,WHITE,WHITE,WHITE);
			}
			else
			{
				Format(g_js_szLastJumpDistance[client], 256, "<font color='#948d8d'>%.1f units</font>", g_js_fJump_Distance[client]);
				...
				if (g_js_fJump_Distance[client] >= g_dist_good_weird && g_js_fJump_Distance[client] < g_dist_pro_weird)
				{
					Format(g_js_szLastJumpDistance[client], 256, "<font color='#676060'><b>%.1f units</b></font>", g_js_fJump_Distance[client]);
					g_js_LeetJump_Count[client]=0;
					PrintToChat(client, "%t", "ClientWeirdJump1",PREFIXCOLOR,WHITE, GRAY,g_js_fJump_Distance[client],GRAY, strafes, WHITE, GRAY, g_js_fPreStrafe[client], WHITE, GRAY,fJump_Height,WHITE, GRAY, sync,PERCENT,WHITE);
					PrintToConsole(client, "        ");
				...
				//pro?
					...
					if (g_js_fJump_Distance[client] >= g_dist_pro_weird && g_js_fJump_Distance[client] < g_dist_leet_weird)
					{
						...
						//Client
						PrintToConsole(client, "        ");
						PrintToChat(client, "%t", "ClientWeirdJump2",PREFIXCOLOR,WHITE,GREEN,WHITE,GREEN,g_js_fJump_Distance[client],WHITE,GREEN,strafes,WHITE,GREEN,g_js_fPreStrafe[client],WHITE,GREEN, g_js_fMax_Speed_Final[client],WHITE,GREEN,fJump_Height,WHITE, GREEN, sync,PERCENT,WHITE);
						PrintToConsole(client, "JS | %s jumped %0.4f units with a WeirdJump [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT);
						PrintToConsole(client, "%s", szStrafeStats);
						decl String:buffer[255];
						Format(buffer, sizeof(buffer), "play %s", PROJUMP_RELATIVE_SOUND_PATH);
						...
						for (new i = 1; i <= MaxClients; i++)
						{
							...
							{
								if (g_bColorChat[i]==true && i != client)
									PrintToChat(i, "%t", "Jumpstats_WeirdAll",PREFIXCOLOR,WHITE,GREEN,szName, MOSSGREEN,GREEN, g_js_fJump_Distance[client],MOSSGREEN,GREEN);
							}
						}
					}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					//Wrecker
						...
						if (g_js_fJump_Distance[client] >= g_dist_wrecker_weird)
						{
							// strafe hack protection
							...
							//Client
							PrintToConsole(client, "        ");
							PrintToChat(client, "%t", "ClientWeirdJump2",PREFIXCOLOR,WHITE,PINK,WHITE,PINK,g_js_fJump_Distance[client],WHITE,PINK,strafes,WHITE,PINK,g_js_fPreStrafe[client],WHITE,PINK, g_js_fMax_Speed_Final[client],WHITE,PINK,fJump_Height,WHITE, PINK, sync,PERCENT,WHITE);
							PrintToConsole(client, "JS | %s jumped %0.4f units with a WeirdJump [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT);
							PrintToConsole(client, "%s", szStrafeStats);
							if (g_js_WreckerJump_Count[client]==3)
								PrintToChat(client, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
							...
							for (new i = 1; i <= MaxClients; i++)
							{
								if (IsValidClient(i))
								{
									if (g_bColorChat[i]==true && i != client)
									{
										PrintToChat(i, "%t", "Jumpstats_WeirdAll",PREFIXCOLOR,WHITE,PINK,szName, PURPLE,PINK, g_js_fJump_Distance[client],PURPLE,PINK);
										if (g_js_WreckerJump_Count[client]==3)
												PrintToChat(i, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
											else
											if (g_js_WreckerJump_Count[client]==5)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					//ownage?
						...
						if (g_js_fJump_Distance[client] >= g_dist_ownage_weird && g_js_fJump_Distance[client] < g_dist_wrecker_weird)
						{
							// strafe hack protection
							if (strafes == 0 || g_js_fPreStrafe[client] < 255.0)
							{
							...
							//Client
							PrintToConsole(client, "        ");
							PrintToChat(client, "%t", "ClientWeirdJump2",PREFIXCOLOR,WHITE,YELLOW,WHITE,YELLOW,g_js_fJump_Distance[client],WHITE,YELLOW,strafes,WHITE,YELLOW,g_js_fPreStrafe[client],WHITE,YELLOW, g_js_fMax_Speed_Final[client],WHITE,YELLOW,fJump_Height,WHITE, YELLOW, sync,PERCENT,WHITE);
							PrintToConsole(client, "JS | %s jumped %0.4f units with a WeirdJump [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT);
							PrintToConsole(client, "%s", szStrafeStats);
							if (g_js_OwnageJump_Count[client]==3)
								PrintToChat(client, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
							...
							for (new i = 1; i <= MaxClients; i++)
							{
								if (IsValidClient(i))
								{
									if (g_bColorChat[i]==true && i != client)
									{
										PrintToChat(i, "%t", "Jumpstats_WeirdAll",PREFIXCOLOR,WHITE,YELLOW,szName, LIGHTYELLOW,YELLOW, g_js_fJump_Distance[client],LIGHTYELLOW,YELLOW);
										if (g_js_OwnageJump_Count[client]==3)
												PrintToChat(i, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
											else
											if (g_js_OwnageJump_Count[client]==5)
					...
					//leet?
						...
						if (g_js_fJump_Distance[client] >= g_dist_leet_weird)
						{
							...
							//Client
							PrintToConsole(client, "        ");
							PrintToChat(client, "%t", "ClientWeirdJump2",PREFIXCOLOR,WHITE,DARKRED,WHITE,DARKRED,g_js_fJump_Distance[client],WHITE,DARKRED,strafes,WHITE,DARKRED,g_js_fPreStrafe[client],WHITE,DARKRED, g_js_fMax_Speed_Final[client],WHITE,DARKRED,fJump_Height,WHITE, DARKRED, sync,PERCENT,WHITE);
							PrintToConsole(client, "JS | %s jumped %0.4f units with a WeirdJump [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height,sync,PERCENT);
							PrintToConsole(client, "%s", szStrafeStats);
							if (g_js_LeetJump_Count[client]==3)
								PrintToChat(client, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
							...
							for (new i = 1; i <= MaxClients; i++)
							{
								if (IsValidClient(i))
								{
									if (g_bColorChat[i]==true && i != client)
									{
										PrintToChat(i, "%t", "Jumpstats_WeirdAll",PREFIXCOLOR,WHITE,DARKRED,szName, RED,DARKRED, g_js_fJump_Distance[client],RED,DARKRED);
										if (g_js_LeetJump_Count[client]==3)
												PrintToChat(i, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
											else
											if (g_js_LeetJump_Count[client]==5)
				...
				if (g_js_fPersonal_Wj_Record[client] < g_js_fJump_Distance[client]  &&  !IsFakeClient(client) && ValidJump)
				{
					if (g_js_fPersonal_Wj_Record[client] > 0.0)
						PrintToChat(client, "%t", "Jumpstats_BeatWjBest",PREFIXCOLOR,WHITE,LIGHTBLUE, g_js_fJump_Distance[client]);
	...
	if (ground_frames < 11 && g_js_Last_Ground_Frames[client] > 10 && fGroundDiff == 0.0 && fJump_Height <= 67.0 && !g_js_bDropJump[client] && g_js_fPreStrafe[client] > 200.0)
	{
		...
		if (g_js_fJump_Distance[client] >= g_dist_good_bhop && g_js_fJump_Distance[client] < g_dist_pro_bhop)
		{
			Format(g_js_szLastJumpDistance[client], 256, "<font color='#676060'><b>%.1f units</b></font>", g_js_fJump_Distance[client]);
			g_js_LeetJump_Count[client]=0;
			PrintToChat(client, "%t", "ClientBunnyhop1",PREFIXCOLOR,WHITE,GRAY, g_js_fJump_Distance[client],GRAY, strafes, WHITE, GRAY, g_js_fPreStrafe[client], WHITE, GRAY, fJump_Height,WHITE, GRAY, sync,PERCENT,WHITE);
			PrintToConsole(client, "        ");
			...
			if (g_js_fJump_Distance[client] >= g_dist_pro_bhop && g_js_fJump_Distance[client] < g_dist_leet_bhop)
			{
				...
				g_js_LeetJump_Count[client]=0;
				PrintToConsole(client, "        ");
				PrintToChat(client, "%t", "ClientBunnyhop2",PREFIXCOLOR,WHITE,GREEN,WHITE,GREEN,g_js_fJump_Distance[client],WHITE,GREEN,strafes,WHITE,GREEN,g_js_fPreStrafe[client],WHITE,GREEN, g_js_fMax_Speed_Final[client],WHITE,GREEN, fJump_Height,WHITE, GREEN, sync,PERCENT,WHITE);
				PrintToConsole(client, "JS | %s jumped %0.4f units with a Bhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height, sync,PERCENT);
				PrintToConsole(client, "%s", szStrafeStats);
				decl String:buffer[255];
				Format(buffer, sizeof(buffer), "play %s", PROJUMP_RELATIVE_SOUND_PATH);
				...
				for (new i = 1; i <= MaxClients; i++)
				{
					...
					{
						if (g_bColorChat[i]==true && i != client)
							PrintToChat(i, "%t", "Jumpstats_BhopAll",PREFIXCOLOR,WHITE,GREEN,szName, MOSSGREEN,GREEN, g_js_fJump_Distance[client],MOSSGREEN,GREEN);
					}
				}
			}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			{
				//Wrecker
				if (g_js_fJump_Distance[client] >= g_dist_wrecker_bhop && g_js_fMax_Speed_Final[client] > 330.0)
				{
					// strafe hack protection
					if (strafes == 0 || g_js_fPreStrafe[client] < 270.0)
					{
					...
					//Client
					PrintToConsole(client, "        ");
					PrintToChat(client, "%t", "ClientBunnyhop2",PREFIXCOLOR,WHITE,PINK,WHITE,PINK,g_js_fJump_Distance[client],WHITE,PINK,strafes,WHITE,PINK,g_js_fPreStrafe[client],WHITE,PINK, g_js_fMax_Speed_Final[client],WHITE,PINK, fJump_Height,WHITE, PINK, sync,PERCENT,WHITE);
					PrintToConsole(client, "JS | %s jumped %0.4f units with a Bhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height, sync,PERCENT);
					PrintToConsole(client, "%s", szStrafeStats);
					if (g_js_WreckerJump_Count[client]==3)
						PrintToChat(client, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
					...
					for (new i = 1; i <= MaxClients; i++)
					{
						if (IsValidClient(i))
						{
							if (g_bColorChat[i]==true && i != client)
							{
								PrintToChat(i, "%t", "Jumpstats_BhopAll",PREFIXCOLOR,WHITE,PINK,szName, PURPLE,PINK, g_js_fJump_Distance[client],PURPLE,PINK);
								if (g_js_WreckerJump_Count[client]==3)
									PrintToChat(i, "%t", "Jumpstats_OnUnstoppable",PREFIXCOLOR,WHITE,PINK,szName);
								else
									if (g_js_WreckerJump_Count[client]==5)
				...
				{
					g_js_WreckerJump_Count[client]=0;
				}
			}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			{
				//ownage?
				if (g_js_fJump_Distance[client] >= g_dist_ownage_bhop && g_js_fJump_Distance[client] < g_dist_wrecker_bhop && g_js_fMax_Speed_Final[client] > 330.0)
				{
					// strafe hack protection
					if (strafes == 0 || g_js_fPreStrafe[client] < 270.0)
					{
					...
					//Client
					PrintToConsole(client, "        ");
					PrintToChat(client, "%t", "ClientBunnyhop2",PREFIXCOLOR,WHITE,YELLOW,WHITE,YELLOW,g_js_fJump_Distance[client],WHITE,YELLOW,strafes,WHITE,YELLOW,g_js_fPreStrafe[client],WHITE,YELLOW, g_js_fMax_Speed_Final[client],WHITE,YELLOW, fJump_Height,WHITE, YELLOW, sync,PERCENT,WHITE);
					PrintToConsole(client, "JS | %s jumped %0.4f units with a Bhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height, sync,PERCENT);
					PrintToConsole(client, "%s", szStrafeStats);
					if (g_js_OwnageJump_Count[client]==3)
						PrintToChat(client, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
					...
					for (new i = 1; i <= MaxClients; i++)
					{
						if (IsValidClient(i))
						{
							if (g_bColorChat[i]==true && i != client)
							{
								PrintToChat(i, "%t", "Jumpstats_BhopAll",PREFIXCOLOR,WHITE,YELLOW,szName, LIGHTYELLOW,YELLOW, g_js_fJump_Distance[client],LIGHTYELLOW,YELLOW);
								if (g_js_OwnageJump_Count[client]==3)
									PrintToChat(i, "%t", "Jumpstats_OnHolyShit",PREFIXCOLOR,WHITE,YELLOW,szName);
								else
									if (g_js_OwnageJump_Count[client]==5)
		...
		if (g_bStrafeSync[client] && g_js_fJump_Distance[client] >= g_dist_good_bhop)
			...
			else
			{
				...
				if (g_js_fJump_Distance[client] >= g_dist_leet_bhop && g_js_fJump_Distance[client] < g_dist_ownage_bhop && g_js_fMax_Speed_Final[client] > 330.0)
				{
					...
					//Client
					PrintToConsole(client, "        ");
					PrintToChat(client, "%t", "ClientBunnyhop2",PREFIXCOLOR,WHITE,DARKRED,WHITE,DARKRED,g_js_fJump_Distance[client],WHITE,DARKRED,strafes,WHITE,DARKRED,g_js_fPreStrafe[client],WHITE,DARKRED, g_js_fMax_Speed_Final[client],WHITE,DARKRED, fJump_Height,WHITE, DARKRED, sync,PERCENT,WHITE);
					PrintToConsole(client, "JS | %s jumped %0.4f units with a Bhop [%i Strafes | %.3f Pre | %.3f Max | Height %.1f | %i%c Sync]",szName, g_js_fJump_Distance[client],strafes, g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client],fJump_Height, sync,PERCENT);
					PrintToConsole(client, "%s", szStrafeStats);
					if (g_js_LeetJump_Count[client]==3)
						PrintToChat(client, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
					...
					for (new i = 1; i <= MaxClients; i++)
					{
						if (IsValidClient(i))
						{
							if (g_bColorChat[i]==true && i != client)
							{
								PrintToChat(i, "%t", "Jumpstats_BhopAll",PREFIXCOLOR,WHITE,DARKRED,szName, RED,DARKRED, g_js_fJump_Distance[client],RED,DARKRED);
								if (g_js_LeetJump_Count[client]==3)
									PrintToChat(i, "%t", "Jumpstats_OnRampage",PREFIXCOLOR,WHITE,DARKRED,szName);
								else
									if (g_js_LeetJump_Count[client]==5)
		...
		if (g_js_fPersonal_Bhop_Record[client] < g_js_fJump_Distance[client]  &&  !IsFakeClient(client) && ValidJump)
		{
			if (g_js_fPersonal_Bhop_Record[client] > 0.0)
				PrintToChat(client, "%t", "Jumpstats_BeatBhopBest",PREFIXCOLOR,WHITE,LIGHTBLUE, g_js_fJump_Distance[client]);
...
public Action:Client_InfoPanel(client, args)
{
	...
	if (g_bInfoPanel[client] == true)
		PrintToChat(client, "%t", "Info1", PREFIXCOLOR,WHITE);
	else
		PrintToChat(client, "%t", "Info2", PREFIXCOLOR,WHITE);
	return Plugin_Handled;
}
...
public JsSettingsMenu(client) {
	...
	AddMenuItem(menu, "0", "JS Settings");
	AddMenuItem(menu, "1", "Hud Color");
	if(CommandExists("sm_beam"))
		AddMenuItem(menu, "2", "Beam Color");
	if(CommandExists("sm_speclistcolor"))
		AddMenuItem(menu, "2", "SpecList Color");
...
public JsSettingsMenuHandler(Handle menu, MenuAction action, client, select) {
	if(action == MenuAction_Select) {
		if(select == 0)
			...
			SpeedPanelColorSettings(client);
		else if(select == 2)
			ClientCommand(client, "sm_beam");
		else if(select == 3)
			ClientCommand(client, "sm_speclistcolor");
	}
...
public ToggleSettings(client) {
	...
	if(g_bInfoPanel[client] == true)
		AddMenuItem(menu, "0", "Speed Panel     [X]");
	else
		AddMenuItem(menu, "0", "Speed Panel     [ ]");
	if(g_bEnableQuakeSounds[client] == true)
		AddMenuItem(menu, "1", "Quake Sounds  [X]");
	else
		AddMenuItem(menu, "1", "Quake Sounds  [ ]");
	if(g_bColorChat[client] == true)
		AddMenuItem(menu, "2", "Color Chat        [X]");
	else
		AddMenuItem(menu, "2", "Color Chat        [ ]");
	SetMenuOptionFlags(menu, MENUFLAG_BUTTON_EXIT);
	DisplayMenu(menu, client, MENU_TIME_FOREVER);
}
...
public SpeedPanelColorSettings(client) {
	Handle menu = CreateMenu(SpeedPanelColorSettingsHandler);
	SetMenuTitle(menu, "Speed Color Settings");
	AddMenuItem(menu, "0", "Blue [Light]");
	AddMenuItem(menu, "1", "Blue [Dark]");
	AddMenuItem(menu, "2", "Cyan");
	AddMenuItem(menu, "3", "Gold");
	AddMenuItem(menu, "4", "Green");
	AddMenuItem(menu, "5", "Green [Mint]");
	AddMenuItem(menu, "6", "Lilac");
	AddMenuItem(menu, "7", "Pink");
	AddMenuItem(menu, "8", "Purple");
	AddMenuItem(menu, "9", "Red");
	AddMenuItem(menu, "10", "Yellow");
	AddMenuItem(menu, "11", "White");

	SetMenuExitBackButton(menu, true);
	DisplayMenu(menu, client, MENU_TIME_FOREVER);
}
public SpeedPanelColorSettingsHandler(Handle menu, MenuAction action, client, select) {
	if(action == MenuAction_Select) {
		g_iSpeedPanelColor[client] = select * 8;
		SpeedPanelColorSettings(client);
		char sCookie[128];
		IntToString(g_iSpeedPanelColor[client], sCookie, sizeof(sCookie));
		SetClientCookie(client, g_hSpeedPanelColorCookie, sCookie);
	}
	else if(action == MenuAction_Cancel)
		JsSettingsMenu(client);
	if(action == MenuAction_End)
...
public Action:Client_StrafeSync(client, args)
{
	...
	if (g_bStrafeSync[client])
		PrintToChat(client, "%t", "StrafeSync1", PREFIXCOLOR,WHITE);
	else
		PrintToChat(client, "%t", "StrafeSync2", PREFIXCOLOR,WHITE);
	return Plugin_Handled;
}
...
public Action:Client_QuakeSounds(client, args)
{
	QuakeSounds(client);
	if (g_bEnableQuakeSounds[client])
		PrintToChat(client, "%t", "QuakeSounds1", PREFIXCOLOR,WHITE);
	else
		PrintToChat(client, "%t", "QuakeSounds2", PREFIXCOLOR,WHITE);
	return Plugin_Handled;
}
...
public Action:Client_Colorchat(client, args)
{
	...
	if (g_bColorChat[client])
		PrintToChat(client, "%t", "Colorchat1", PREFIXCOLOR,WHITE);
	else
		PrintToChat(client, "%t", "Colorchat2", PREFIXCOLOR,WHITE);
	return Plugin_Handled;
}
	...
	if (g_js_OwnageJump_Count[client] == 3 || g_js_OwnageJump_Count[client] == 5) {
		for (new i = 1; i <= MaxClients+1; i++) { 
			if(IsValidClient(i) && !IsFakeClient(i) && i != client && g_bColorChat[i] && g_bEnableQuakeSounds[i]) {	
				if (g_js_OwnageJump_Count[client]==3) {
					ClientCommand(i, "play %s", OWNAGEJUMP_HOLYSHIT_RELATIVE_SOUND_PATH);
				} else if (g_js_OwnageJump_Count[client]==5) {
					ClientCommand(i, "play %s", OWNAGEJUMP_WICKEDSICK_RELATIVE_SOUND_PATH);
				}
			}
		}
	}
...
public PlayWreckerJumpSound(client) {
	if (g_js_WreckerJump_Count[client] == 3 || g_js_WreckerJump_Count[client] == 5) {
		for (new i = 1; i <= MaxClients+1; i++) { 
			if(IsValidClient(i) && !IsFakeClient(i) && i != client && g_bColorChat[i] && g_bEnableQuakeSounds[i]) {	
				if (g_js_WreckerJump_Count[client]==3) {
					ClientCommand(i, "play %s", WRECKERJUMP_UNSTOPPABLE_RELATIVE_SOUND_PATH);
				} else if (g_js_WreckerJump_Count[client]==5) {
					ClientCommand(i, "play %s", WRECKERJUMP_COMBOWHORE_RELATIVE_SOUND_PATH);
				}
			}
		}
	}
	...
	if (IsValidClient(client) && !IsFakeClient(client) && g_bEnableQuakeSounds[client]) {
		...
		} else if (g_js_WreckerJump_Count[client]==3) {
			for (new i = 1; i <= MaxClients+1; i++) {
				if(IsValidClient(i) && !IsFakeClient(i) && g_bEnableQuakeSounds[i]) {
					ClientCommand(i, "play %s", WRECKERJUMP_UNSTOPPABLE_RELATIVE_SOUND_PATH);
				}
...
public JumpTopMenuHandler(Handle:menu, MenuAction:action, param1,param2)
{
	if(action == MenuAction_Select)
	{
		switch(param2)
		{
			case 0: JumpTopLjMenu(param1);
			case 1: JumpTopLjBlockMenu(param1);
...
public JumpTopLjMenu(client)
{
	new Handle:topmenu2 = CreateMenu(JumpTopLjMenuHandler);
	SetMenuTitle(topmenu2, "LJ:");
	AddMenuItem(topmenu2, "!lj", "Top 20 LongJump");
	AddMenuItem(topmenu2, "!ljpre", "Top 20 LongJump[P]");
	SetMenuOptionFlags(topmenu2, MENUFLAG_BUTTON_EXIT);
	DisplayMenu(topmenu2, client, MENU_TIME_FOREVER);
}

public JumpTopLjMenuHandler(Handle:menu, MenuAction:action, param1,param2)
{
	if(action == MenuAction_Select)
	{
		switch(param2)
		{
			...
			case 1: db_selectTopLjCps(param1);
		}
	}
}

public JumpTopLjBlockMenu(client)
{
	new Handle:topmenu2 = CreateMenu(JumpTopLjBlockMenuHandler);
	SetMenuTitle(topmenu2, "LJ Block:");
	AddMenuItem(topmenu2, "!ljblock", "Top 20 Block Longjump");
	AddMenuItem(topmenu2, "!ljblockp", "Top 20 Block Longjump[P]");
	SetMenuOptionFlags(topmenu2, MENUFLAG_BUTTON_EXIT);
	DisplayMenu(topmenu2, client, MENU_TIME_FOREVER);
}

public JumpTopLjBlockMenuHandler(Handle:menu, MenuAction:action, param1,param2)
{
	if(action == MenuAction_Select)
	{
		switch(param2)
		{
			case 0: db_selectTopLjBlock(param1);
			case 1: db_selectTopLjCpsBlock(param1);
		}
	}
}
...
public db_updateLjCPSRecord(client)
{
	decl String:szQuery[255];
	decl String:szSteamId[32];
	if (IsValidClient(client))
		...
		return;
	Format(szQuery, 255, sql_selectPlayerJumpLJCps, szSteamId);
	if (!IsFakeClient(client))
		SQL_TQuery(g_hDb, SQL_UpdateLjCpsRecordCallback, szQuery, client,DBPrio_Low);
}

public db_updateLjCPSBlockRecord(client)
{
	decl String:szQuery[255];
	decl String:szSteamId[32];
	if (IsValidClient(client))
		...
		return;
	Format(szQuery, 255, sql_selectPlayerJumpLJCpsBlock, szSteamId);
	if (!IsFakeClient(client))
		SQL_TQuery(g_hDb, SQL_UpdateLjCpsBlockRecordCallback, szQuery, client,DBPrio_Low);
}
...
public SQL_UpdateLjCpsRecordCallback(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	new client = data;
	if (IsValidClient(client))
	{
		...
		if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
		{
			Format(szQuery, 512, sql_updateLjCps, szName, g_js_fPersonal_LjCps_Record[client], g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client], g_js_Strafes_Final[client],g_js_Sync_Final[client],g_flastHeight[client], szSteamId);
			SQL_TQuery(g_hDb, SQL_CheckCallback, szQuery,DBPrio_Low);
		}
		else
		{
			Format(szQuery, 512, sql_insertPlayerJumpLjCps, szSteamId, szName, g_js_fPersonal_LjCps_Record[client], g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client], g_js_Strafes_Final[client],g_js_Sync_Final[client],g_flastHeight[client]);
			SQL_TQuery(g_hDb, SQL_CheckCallback, szQuery,DBPrio_Low);
		}
		db_viewLjCpsRecord2(client);
	}
}
	...
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		...
		if (rank < 21 && rank < g_js_BhopRank[client])
		{
			...
			for(new i = 1; i <= MaxClients; i++)
			{
				...
				{
					PrintToChat(i, "%t", "Jumpstats_BhopTop", PREFIXCOLOR, WHITE, LIGHTYELLOW, szName, rank, g_js_fPersonal_Bhop_Record[client]);
	...
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		...
		if (rank < 21 && rank < g_js_DropBhopRank[client])
		{
			...
			for(new i = 1; i <= MaxClients; i++)
			{
				if(IsValidClient(i) && !IsFakeClient(i))
				{
					PrintToChat(i, "%t", "Jumpstats_DropBhopTop", PREFIXCOLOR, WHITE, LIGHTYELLOW, szName, rank, g_js_fPersonal_DropBhop_Record[client]);
	...
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		...
		if (rank < 21 && rank < g_js_MultiBhopRank[client])
		{
			...
			for(new i = 1; i <= MaxClients; i++)
			{
				if(IsValidClient(i) && !IsFakeClient(i))
				{
					PrintToChat(i, "%t", "Jumpstats_MultiBhopTop", PREFIXCOLOR, WHITE, LIGHTYELLOW, szName, rank, g_js_fPersonal_MultiBhop_Record[client]);
...
public db_viewLjCpsRecord2(client)
{
	decl String:szQuery[512];
	decl String:szSteamId[32];
	if (IsValidClient(client))
		...
		return;
	Format(szQuery, 512, sql_selectPlayerJumpLJCps, szSteamId);
	SQL_TQuery(g_hDb, SQL_viewLjCps2RecordCallback, szQuery, client,DBPrio_Low);
}
...
public db_viewLjCpsBlockRecord2(client)
{
	decl String:szQuery[512];
	decl String:szSteamId[32];
	if (IsValidClient(client))
		...
		return;
	Format(szQuery, 512, sql_selectPlayerJumpLJCpsBlock, szSteamId);
	SQL_TQuery(g_hDb, SQL_viewLjCpsBlock2RecordCallback, szQuery, client,DBPrio_Low);
}
...
public SQL_viewLjCpsBlock2RecordCallback(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	new client = data;
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		...
		WritePackCell(pack, client);
		WritePackString(pack, szName);
		Format(szQuery, 512, sql_selectPlayerRankLjCpsBlock, szSteamId);
		SQL_TQuery(g_hDb, SQL_viewLjCpsBlock2RecordCallback2, szQuery, pack,DBPrio_Low);
	}
}
...
public SQL_viewLjCps2RecordCallback(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	new client = data;
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		...
		WritePackCell(pack, client);
		WritePackString(pack, szName);
		Format(szQuery, 512, sql_selectPlayerRankLjCps, szSteamId);
		SQL_TQuery(g_hDb, SQL_viewLjCps2RecordCallback2, szQuery, pack,DBPrio_Low);
	}
}
	...
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		...
		if (rank < 21 && rank < g_js_LjBlockRank[client])
		{
			...
			for(new i = 1; i <= MaxClients; i++)
			{
				if(IsValidClient(i) && !IsFakeClient(i))
				{
					PrintToChat(i, "%t", "Jumpstats_LjBlockTop", PREFIXCOLOR, WHITE, LIGHTYELLOW, szName, rank, g_js_Personal_LjBlock_Record[client],g_js_fPersonal_LjBlockRecord_Dist[client]);
...
public SQL_viewLjCpsBlock2RecordCallback2(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		decl String:szName[MAX_NAME_LENGTH];
		...
		if (rank < 21 && rank < g_js_LjCpsBlockRank[client])
		{
			g_js_LjCpsBlockRank[client] = rank;
			for(new i = 1; i <= MaxClients; i++)
			{
				if(IsValidClient(i) && !IsFakeClient(i))
				{
					PrintToChat(i, "%t", "Jumpstats_LjCPSBlockTop", PREFIXCOLOR, WHITE, LIGHTYELLOW, szName, rank, g_js_Personal_LjCpsBlock_Record[client],g_js_fPersonal_LjCpsBlockRecord_Dist[client]);
					PrintToConsole(i, "JS | %s is now #%i in the Longjump[P] 20! [%i units block/%.3f units jump]", szName, rank, g_js_Personal_LjCpsBlock_Record[client],g_js_fPersonal_LjCpsBlockRecord_Dist[client]);
				}
			}
		}
	}
	...
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		...
		if (rank < 21 && rank < g_js_LjRank[client])
		{
			...
			for(new i = 1; i <= MaxClients; i++)
			{
				if(IsValidClient(i) && !IsFakeClient(i))
				{
					PrintToChat(i, "%t", "Jumpstats_LjTop", PREFIXCOLOR, WHITE, LIGHTYELLOW, szName, rank, g_js_fPersonal_Lj_Record[client]);
...
public SQL_viewLjCps2RecordCallback2(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		decl String:szName[MAX_NAME_LENGTH];
		...
		if (rank < 21 && rank < g_js_LjCpsRank[client])
		{
			g_js_LjCpsRank[client] = rank;
			for(new i = 1; i <= MaxClients; i++)
			{
				if(IsValidClient(i) && !IsFakeClient(i))
				{
					PrintToChat(i, "%t", "Jumpstats_LjCPSTop", PREFIXCOLOR, WHITE, LIGHTYELLOW, szName, rank, g_js_fPersonal_LjCps_Record[client]);
					PrintToConsole(i, "JS | %s is now #%i in the Longjump[P] 20! [%.3f units]", szName, rank, g_js_fPersonal_LjCps_Record[client]);
				}
			}
		}
	}
	...
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		...
		if (rank < 21 && rank < g_js_WjRank[client])
		{
			...
			for(new i = 1; i <= MaxClients; i++)
			{
				if(IsValidClient(i) && !IsFakeClient(i))
				{
					PrintToChat(i, "%t", "Jumpstats_WjTop", PREFIXCOLOR, WHITE, LIGHTYELLOW, szName, rank, g_js_fPersonal_Wj_Record[client]);
...
public SQL_UpdateLjCpsBlockRecordCallback(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	new client = data;
	if (IsValidClient(client))
	{
		...
		if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
		{
			Format(szQuery, 512, sql_updateLjCpsBlock, szName, g_js_Personal_LjCpsBlock_Record[client], g_js_fPersonal_LjCpsBlockRecord_Dist[client], g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client], g_js_Strafes_Final[client],g_js_Sync_Final[client],g_flastHeight[client], szSteamId);
			SQL_TQuery(g_hDb, SQL_CheckCallback, szQuery,DBPrio_Low);
			}
		else
		{
			Format(szQuery, 512, sql_insertPlayerJumpLjCpsBlock , szSteamId, szName, g_js_Personal_LjCpsBlock_Record[client], g_js_fPersonal_LjCpsBlockRecord_Dist[client], g_js_fPreStrafe[client], g_js_fMax_Speed_Final[client], g_js_Strafes_Final[client],g_js_Sync_Final[client],g_flastHeight[client]);
			SQL_TQuery(g_hDb, SQL_CheckCallback, szQuery,DBPrio_Low);
			}
		db_viewLjCpsBlockRecord2(client);
	}
}
...
public db_selectTopLjCps(client)
{
	decl String:szQuery[1024];
	Format(szQuery, 1024, sql_selectPlayerJumpTopLJCps);
	SQL_TQuery(g_hDb, sql_selectPlayerJumpTopLJCpsCallback, szQuery, client,DBPrio_Low);
}
...
public db_selectTopLjCpsBlock(client)
{
	decl String:szQuery[1024];
	Format(szQuery, 1024, sql_selectPlayerJumpTopLJCpsBlock);
	SQL_TQuery(g_hDb, sql_selectPlayerJumpTopLJCpsBlockCallback, szQuery, client,DBPrio_Low);
}
...
public sql_selectPlayerJumpTopLJCpsBlockCallback(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	new client = data;
	decl String:szValue[128];
	decl String:szName[64];
	decl String:szSteamID[32];
	new ljcpsblock;
	new Float:ljcpsrecord;
	new String:szStrafes[32];
	new strafes;
	new Handle:menu = CreateMenu(LjCpsBlockJumpMenuHandler1);
	SetMenuTitle(menu, "Top 20 Block Longjump[P]\n    Rank    Block   Distance           Strafes      Player");
	SetMenuPagination(menu, 5);
	if(SQL_HasResultSet(hndl))
	{
		new i = 1;
		...
		{
			SQL_FetchString(hndl, 0, szName, 64);
			ljcpsblock = SQL_FetchInt(hndl, 1);
			ljcpsrecord = SQL_FetchFloat(hndl, 2);
			strafes = SQL_FetchInt(hndl, 3);
			SQL_FetchString(hndl, 4, szSteamID, 32);
			if (strafes < 10)
				Format(szStrafes, 32, " %i ", strafes);
				...
				Format(szStrafes, 32, "%i", strafes);
			if (i < 10)
					Format(szValue, 128, "[0%i.]    %i     %.3f units       %s      » %s", i, ljcpsblock,ljcpsrecord,szStrafes, szName);
				else
					Format(szValue, 128, "[%i.]    %i     %.3f units       %s      » %s", i, ljcpsblock,ljcpsrecord,szStrafes, szName);
			AddMenuItem(menu, szSteamID, szValue, ITEMDRAW_DEFAULT);
			i++;
		}
	}
...
public sql_selectPlayerJumpTopLJCpsCallback(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	new client = data;
	decl String:szValue[128];
	decl String:szName[64];
	...
	new String:szStrafes[32];
	new strafes;
	new Handle:menu = CreateMenu(LjCpsJumpMenuHandler1);
	SetMenuTitle(menu, "Top 20 Longjump[P]\n    Rank    Distance           Strafes      Player");
	SetMenuPagination(menu, 5);
	if(SQL_HasResultSet(hndl))
	{
		new i = 1;
		...
		{
			SQL_FetchString(hndl, 0, szName, 64);
			ljcpsrecord = SQL_FetchFloat(hndl, 1);
			strafes = SQL_FetchInt(hndl, 2);
			SQL_FetchString(hndl, 3, szSteamID, 32);
			if (strafes < 10)
				Format(szStrafes, 32, " %i ", strafes);
				...
				Format(szStrafes, 32, "%i", strafes);
			if (i < 10)
					Format(szValue, 128, "[0%i.]    %.3f units      %s      » %s", i, ljcpsrecord,szStrafes, szName);
				else
					Format(szValue, 128, "[%i.]    %.3f units      %s      » %s", i, ljcpsrecord,szStrafes, szName);
			AddMenuItem(menu, szSteamID, szValue, ITEMDRAW_DEFAULT);
			i++;
		}
	}
...
public LjCpsBlockJumpMenuHandler1(Handle:menu, MenuAction:action, param1, param2)
{
	if (action ==  MenuAction_Select)
	{
		JumpTopMenu(param1);
...
public LjCpsJumpMenuHandler1(Handle:menu, MenuAction:action, param1, param2)
{
	if (action ==  MenuAction_Select)
	{
		g_bdetailView[param1]=true;
...
public SQL_ViewJumpStatsCallback(Handle:owner, Handle:hndl, const String:error[], any:data) // Thx Exd for helping me understand the tables [ https://github.com/exd02 ]
{
	new client = data;
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
        ...
        new Float:ljcpsrecord = SQL_FetchFloat(hndl, 40);
		new Float:ljcpspre = SQL_FetchFloat(hndl, 41);
		new Float:ljcpsmax = SQL_FetchFloat(hndl, 42);
		new ljcpsstrafes = SQL_FetchInt(hndl, 43);
		new ljcpssync = SQL_FetchInt(hndl, 44);
	    new Float:ljcpsheight = SQL_FetchFloat(hndl, 45);
        new ljcpsblockdist = SQL_FetchInt(hndl, 46);
		new Float:ljcpsblockrecord = SQL_FetchFloat(hndl, 47);
		new Float:ljcpsblockpre = SQL_FetchFloat(hndl, 48);
		new Float:ljcpsblockmax = SQL_FetchFloat(hndl, 49);
		new ljcpsblockstrafes = SQL_FetchInt(hndl, 50);
		new ljcpsblocksync = SQL_FetchInt(hndl, 51);
		new Float:ljcpsblockheight = SQL_FetchFloat(hndl, 52);


		if (bhoprecord >0.0 || ljrecord > 0.0 || multibhoprecord > 0.0 || wjrecord > 0.0 || dropbhoprecord > 0.0 || ljcpsrecord > 0.0 || ljblockdist > 0 || ljcpsblockdist > 0) 
		{
			...
			{
				if (ljcpsstrafes>9)
					Format(szVr, 255, "LJ[P]:       %.3f     %i      %.2f   %.2f  %.1f      %i%c", ljcpsrecord,ljcpsstrafes,ljcpspre,ljcpsmax,ljcpsheight,ljcpssync,PERCENT);
				else
					Format(szVr, 255, "LJ[P]:       %.3f     %i      %.2f   %.2f  %.1f      %i%c", ljcpsrecord,ljcpsstrafes,ljcpspre,ljcpsmax,ljcpsheight,ljcpssync,PERCENT);
				AddMenuItem(menu, szVr, szVr);
			}
			...
			if (multibhoprecord > 0.0)
			{
				if (multibhopstrafes>9)
					Format(szVr, 255, "MBHOP:    %.3f     %i      %.2f   %.2f  %.1f     %i%c", multibhoprecord,multibhopstrafes,multibhoppre,multibhopmax,multibhopheight,multibhopsync,PERCENT);
				else
					Format(szVr, 255, "MBHOP:    %.3f     %i      %.2f   %.2f  %.1f     %i%c", multibhoprecord,multibhopstrafes,multibhoppre,multibhopmax,multibhopheight,multibhopsync,PERCENT);
				AddMenuItem(menu, szVr, szVr);
			}
			if (dropbhoprecord > 0.0)
			{
				if (dropbhopstrafes>9)
					Format(szVr, 255, "DBHOP:    %.3f     %i      %.2f   %.2f   %.1f      %i%c", dropbhoprecord,dropbhopstrafes,dropbhoppre,dropbhopmax,dropbhopheight,dropbhopsync,PERCENT);
				else
					Format(szVr, 255, "DBHOP:    %.3f     %i      %.2f   %.2f   %.1f      %i%c", dropbhoprecord,dropbhopstrafes,dropbhoppre,dropbhopmax,dropbhopheight,dropbhopsync,PERCENT);
				AddMenuItem(menu, szVr, szVr);
			}
			...
			{
				if (ljstrafes>9)
					Format(szVr, 255, "BLOCK:      %i|%.1f    %i      %.2f    %.2f    %.1f     %i%c", ljblockdist,ljblockrecord,ljblockstrafes,ljblockpre,ljblockmax,ljblockheight,ljblocksync,PERCENT);
				else
					Format(szVr, 255, "BLOCK:      %i|%.1f    %i      %.2f    %.2f    %.1f     %i%c", ljblockdist,ljblockrecord,ljblockstrafes,ljblockpre,ljblockmax,ljblockheight,ljblocksync,PERCENT);
				AddMenuItem(menu, szVr, szVr);
			}
			...
			{
				if (ljcpsstrafes>9)
					Format(szVr, 255, "BLOCK[P]: %i|%.1f   %i      %.2f    %.2f   %.1f     %i%c\n \n \n", ljcpsblockdist,ljcpsblockrecord,ljcpsblockstrafes,ljcpsblockpre,ljcpsblockmax,ljcpsblockheight,ljcpsblocksync,PERCENT);
				else
					Format(szVr, 255, "BLOCK[P]: %i|%.1f   %i      %.2f    %.2f   %.1f     %i%c\n \n \n", ljcpsblockdist,ljcpsblockrecord,ljcpsblockstrafes,ljcpsblockpre,ljcpsblockmax,ljcpsblockheight,ljcpsblocksync,PERCENT);
				AddMenuItem(menu, szVr, szVr);
			}
			if(CheckCommandAccess(client, "sm_resetplayerjumpstats", ADMFLAG_CHANGEMAP)) {
				ResetID[client] = szSteamId;
				AddMenuItem(menu, "4", "Reset Player");
				AddMenuItem(menu, "5", "Ban Player [30D]");
			}
			SetMenuPagination(menu, 5);
			...
			PrintToChat(client, "%t", "noJumpRecords",PREFIXCOLOR,WHITE);
	}
	else
	{
		PrintToChat(client, "%t", "noJumpRecords",PREFIXCOLOR,WHITE);
...
public int JumpStatsMenuHandler(Menu menu, MenuAction action, int client, int info) {
	if(action == MenuAction_Select) {
		...
		if(!(StrEqual(choice, "4")) && !(StrEqual(choice, "5")))
			JumpTopMenu(client);
			...
			for (new i = 1; i <= MaxClients; i++) {
				if(IsValidClient(i)) {
					...
					if(StrEqual(szSteamId2,szsteamid)) {
						...
						g_js_LjCpsRank[i] = 99999999;
						g_js_fPersonal_LjCps_Record[i] = -1.0;
					}
				}
			}
			JumpTopMenu(client);
...
public db_viewPersonalLJCPSRecord(client, String:szSteamId[32])
{
	decl String:szQuery[512];
	Format(szQuery, 512, sql_selectPlayerJumpLJCps, szSteamId);
	SQL_TQuery(g_hDb, SQL_LJCPSRecordCallback, szQuery, client,DBPrio_Low);
}
...
public SQL_LJCPSRecordCallback(Handle:owner, Handle:hndl, const String:error[], any:data) // VOLTAR AQUI
{
	new client = data;
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		g_js_fPersonal_LjCps_Record[client] = SQL_FetchFloat(hndl, 2);
		if (g_js_fPersonal_LjCps_Record[client] > -1.0)
		{
			decl String:szSteamId[32];
			decl String:szQuery[512];
			if (IsValidClient(client))
			{
				GetClientAuthId(client, AuthId_Steam2, szSteamId, 32);
				Format(szQuery, 255, sql_selectPlayerRankLjCps, szSteamId);
				SQL_TQuery(g_hDb, SQL_viewLjCpsRecordCallback2, szQuery, client,DBPrio_Low);
			}
		}
		else
		{
			g_js_LjCpsRank[client] = 99999999;
			g_js_fPersonal_LjCps_Record[client] = -1.0;
		}
	}
	else
	{
...
public db_viewPersonalLJCPSBlockRecord(client, String:szSteamId[32])
{
	decl String:szQuery[512];
	Format(szQuery, 512, sql_selectPlayerJumpLJCpsBlock, szSteamId);
	SQL_TQuery(g_hDb, SQL_LJCpsBlockRecordCallback, szQuery, client,DBPrio_Low);
}
...
public SQL_LJCpsBlockRecordCallback(Handle:owner, Handle:hndl, const String:error[], any:data) // VOLTAR AQUI
{
	new client = data;
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		g_js_Personal_LjCpsBlock_Record[client] = SQL_FetchInt(hndl, 2);
		g_js_fPersonal_LjCpsBlockRecord_Dist[client] = SQL_FetchFloat(hndl, 3);
		if (g_js_Personal_LjCpsBlock_Record[client] > -1)
		{
			decl String:szSteamId[32];
			decl String:szQuery[512];
			if (IsValidClient(client))
			{
				GetClientAuthId(client, AuthId_Steam2, szSteamId, 32);
				Format(szQuery, 255, sql_selectPlayerRankLjCpsBlock, szSteamId);
				SQL_TQuery(g_hDb, SQL_viewLjCpsBlockRecordCallback2, szQuery, client,DBPrio_Low);
			}
		}
		else
		{
		g_js_LjCpsBlockRank[client] = 99999999;
		g_js_Personal_LjCpsBlock_Record[client] = -1;
		g_js_fPersonal_LjCpsBlockRecord_Dist[client] = -1.0;
		}
	}
	else
	{
...
public SQL_viewLjCpsRecordCallback2(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	new client = data;
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		g_js_LjCpsRank[client]= SQL_GetRowCount(hndl);
	}
}
...
public SQL_viewLjCpsBlockRecordCallback2(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	new client = data;
	if(SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		g_js_LjCpsBlockRank[client]= SQL_GetRowCount(hndl);
	}
}
	...
	for (new i = 1; i <= MaxClients; i++)
	{
		if (IsValidClient(i))
		{
			...
			if(StrEqual(szSteamId2,szsteamid))
			{
				...
				g_js_LjCpsBlockRank[i] = 99999999;
				g_js_Personal_LjCpsBlock_Record[i] = -1;
			}
		}
	}
}
